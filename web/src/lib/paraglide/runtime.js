 ...
 *   }
 */
export const locales = /** @type {const} */ (["en", "sv", "uk", "zh", "es", "hi", "pt", "bn", "ru", "ja", "pa", "vi", "yue", "tr", "ar", "wuu", "mr", "nb", "fi", "da", "et", "lv", "lt", "pl", "de", "nl", "fr", "it", "hu", "cs", "ro", "el", "bg", "hr", "sr", "sk", "sl"]);
/** @type {string} */
