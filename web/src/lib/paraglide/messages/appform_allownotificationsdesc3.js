...
/** @typedef {{}} Appform_Allownotificationsdesc3Inputs */

const en_appform_allownotificationsdesc3 = /** @type {(inputs: Appform_Allownotificationsdesc3Inputs) => LocalizedString} */ () => {
...
const ko_appform_allownotificationsdesc3 = /** @type {(inputs: Appform_Allownotificationsdesc3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`이 앱에 대해 Muximux 알림 브리지 활성화`)
};

/**
* | output |
* | --- |
* | "Enable the Muximux notification bridge for this app" |
*
* @param {Appform_Allownotificationsdesc3Inputs} inputs
...
*/
const appform_allownotificationsdesc3 = /** @type {((inputs?: Appform_Allownotificationsdesc3Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Appform_Allownotificationsdesc3Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "sv") return sv_appform_allownotificationsdesc3(inputs)
	if (locale === "uk") return uk_appform_allownotificationsdesc3(inputs)
	if (locale === "zh") return zh_appform_allownotificationsdesc3(inputs)
	if (locale === "es") return es_appform_allownotificationsdesc3(inputs)
	if (locale === "hi") return hi_appform_allownotificationsdesc3(inputs)
	if (locale === "pt") return pt_appform_allownotificationsdesc3(inputs)
	if (locale === "bn") return bn_appform_allownotificationsdesc3(inputs)
	if (locale === "ru") return ru_appform_allownotificationsdesc3(inputs)
	if (locale === "ja") return ja_appform_allownotificationsdesc3(inputs)
	if (locale === "vi") return vi_appform_allownotificationsdesc3(inputs)
	if (locale === "yue") return yue_appform_allownotificationsdesc3(inputs)
	if (locale === "tr") return tr_appform_allownotificationsdesc3(inputs)
	if (locale === "ar") return ar_appform_allownotificationsdesc3(inputs)
	if (locale === "wuu") return wuu_appform_allownotificationsdesc3(inputs)
	if (locale === "mr") return mr_appform_allownotificationsdesc3(inputs)
	if (locale === "nb") return nb_appform_allownotificationsdesc3(inputs)
	if (locale === "fi") return fi_appform_allownotificationsdesc3(inputs)
	if (locale === "da") return da_appform_allownotificationsdesc3(inputs)
	if (locale === "et") return et_appform_allownotificationsdesc3(inputs)
	if (locale === "lv") return lv_appform_allownotificationsdesc3(inputs)
	if (locale === "lt") return lt_appform_allownotificationsdesc3(inputs)
	if (locale === "pl") return pl_appform_allownotificationsdesc3(inputs)
	if (locale === "de") return de_appform_allownotificationsdesc3(inputs)
	if (locale === "nl") return nl_appform_allownotificationsdesc3(inputs)
	if (locale === "fr") return fr_appform_allownotificationsdesc3(inputs)
	if (locale === "it") return it_appform_allownotificationsdesc3(inputs)
	if (locale === "hu") return hu_appform_allownotificationsdesc3(inputs)
	if (locale === "cs") return cs_appform_allownotificationsdesc3(inputs)
	if (locale === "ro") return ro_appform_allownotificationsdesc3(inputs)
	if (locale === "el") return el_appform_allownotificationsdesc3(inputs)
	if (locale === "bg") return bg_appform_allownotificationsdesc3(inputs)
	if (locale === "hr") return hr_appform_allownotificationsdesc3(inputs)
	if (locale === "sr") return sr_appform_allownotificationsdesc3(inputs)
	if (locale === "sk") return sk_appform_allownotificationsdesc3(inputs)
	if (locale === "sl") return sl_appform_allownotificationsdesc3(inputs)
	if (locale === "ko") return ko_appform_allownotificationsdesc3(inputs)
	return en_appform_allownotificationsdesc3(inputs)
});
export { appform_allownotificationsdesc3 as "appForm_allowNotificationsDesc" }