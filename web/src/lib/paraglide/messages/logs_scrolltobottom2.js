...
/** @typedef {{}} Logs_Scrolltobottom2Inputs */

const en_logs_scrolltobottom2 = /** @type {(inputs: Logs_Scrolltobottom2Inputs) => LocalizedString} */ () => {
...
const ko_logs_scrolltobottom2 = /** @type {(inputs: Logs_Scrolltobottom2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`맨 아래로 스크롤`)
};
...
const logs_scrolltobottom2 = /** @type {((inputs?: Logs_Scrolltobottom2Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Logs_Scrolltobottom2Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_logs_scrolltobottom2(inputs)
	if (locale === "zh") return zh_logs_scrolltobottom2(inputs)
	if (locale === "es") return es_logs_scrolltobottom2(inputs)
	if (locale === "hi") return hi_logs_scrolltobottom2(inputs)
	if (locale === "pt") return pt_logs_scrolltobottom2(inputs)
	...
	if (locale === "ar") return ar_logs_scrolltobottom2(inputs)
	if (locale === "wuu") return wuu_logs_scrolltobottom2(inputs)
	if (locale === "mr") return mr_logs_scrolltobottom2(inputs)
	if (locale === "nb") return nb_logs_scrolltobottom2(inputs)
	if (locale === "fi") return fi_logs_scrolltobottom2(inputs)
	if (locale === "da") return da_logs_scrolltobottom2(inputs)
	if (locale === "et") return et_logs_scrolltobottom2(inputs)
	if (locale === "lv") return lv_logs_scrolltobottom2(inputs)
	if (locale === "lt") return lt_logs_scrolltobottom2(inputs)
	if (locale === "pl") return pl_logs_scrolltobottom2(inputs)
	if (locale === "de") return de_logs_scrolltobottom2(inputs)
	if (locale === "nl") return nl_logs_scrolltobottom2(inputs)
	if (locale === "fr") return fr_logs_scrolltobottom2(inputs)
	if (locale === "it") return it_logs_scrolltobottom2(inputs)
	if (locale === "hu") return hu_logs_scrolltobottom2(inputs)
	if (locale === "cs") return cs_logs_scrolltobottom2(inputs)
	if (locale === "ro") return ro_logs_scrolltobottom2(inputs)
	if (locale === "el") return el_logs_scrolltobottom2(inputs)
	if (locale === "bg") return bg_logs_scrolltobottom2(inputs)
	if (locale === "hr") return hr_logs_scrolltobottom2(inputs)
	if (locale === "sr") return sr_logs_scrolltobottom2(inputs)
	if (locale === "sk") return sk_logs_scrolltobottom2(inputs)
	if (locale === "sl") return sl_logs_scrolltobottom2(inputs)
	if (locale === "ko") return ko_logs_scrolltobottom2(inputs)
	return en_logs_scrolltobottom2(inputs)
});
export { logs_scrolltobottom2 as "logs_scrollToBottom" }