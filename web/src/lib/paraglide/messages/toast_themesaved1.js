...
/** @typedef {{}} Toast_Themesaved1Inputs */

const en_toast_themesaved1 = /** @type {(inputs: Toast_Themesaved1Inputs) => LocalizedString} */ () => {
...
const ko_toast_themesaved1 = /** @type {(inputs: Toast_Themesaved1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`테마가 저장되었습니다`)
};
...
const toast_themesaved1 = /** @type {((inputs?: Toast_Themesaved1Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Toast_Themesaved1Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_toast_themesaved1(inputs)
	if (locale === "zh") return zh_toast_themesaved1(inputs)
	if (locale === "es") return es_toast_themesaved1(inputs)
	if (locale === "hi") return hi_toast_themesaved1(inputs)
	if (locale === "pt") return pt_toast_themesaved1(inputs)
	...
	if (locale === "ar") return ar_toast_themesaved1(inputs)
	if (locale === "wuu") return wuu_toast_themesaved1(inputs)
	if (locale === "mr") return mr_toast_themesaved1(inputs)
	if (locale === "nb") return nb_toast_themesaved1(inputs)
	if (locale === "fi") return fi_toast_themesaved1(inputs)
	if (locale === "da") return da_toast_themesaved1(inputs)
	if (locale === "et") return et_toast_themesaved1(inputs)
	if (locale === "lv") return lv_toast_themesaved1(inputs)
	if (locale === "lt") return lt_toast_themesaved1(inputs)
	if (locale === "pl") return pl_toast_themesaved1(inputs)
	if (locale === "de") return de_toast_themesaved1(inputs)
	if (locale === "nl") return nl_toast_themesaved1(inputs)
	if (locale === "fr") return fr_toast_themesaved1(inputs)
	if (locale === "it") return it_toast_themesaved1(inputs)
	if (locale === "hu") return hu_toast_themesaved1(inputs)
	if (locale === "cs") return cs_toast_themesaved1(inputs)
	if (locale === "ro") return ro_toast_themesaved1(inputs)
	if (locale === "el") return el_toast_themesaved1(inputs)
	if (locale === "bg") return bg_toast_themesaved1(inputs)
	if (locale === "hr") return hr_toast_themesaved1(inputs)
	if (locale === "sr") return sr_toast_themesaved1(inputs)
	if (locale === "sk") return sk_toast_themesaved1(inputs)
	if (locale === "sl") return sl_toast_themesaved1(inputs)
	if (locale === "ko") return ko_toast_themesaved1(inputs)
	return en_toast_themesaved1(inputs)
});
export { toast_themesaved1 as "toast_themeSaved" }