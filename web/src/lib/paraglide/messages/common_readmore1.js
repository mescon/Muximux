...
/** @typedef {{}} Common_Readmore1Inputs */

const en_common_readmore1 = /** @type {(inputs: Common_Readmore1Inputs) => LocalizedString} */ () => {
...
const ko_common_readmore1 = /** @type {(inputs: Common_Readmore1Inputs) => LocalizedString} */ () => {
...
* | "Read more" |
*
* @param {Common_Readmore1Inputs} inputs
...
*/
const common_readmore1 = /** @type {((inputs?: Common_Readmore1Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Common_Readmore1Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "sv") return sv_common_readmore1(inputs)
	if (locale === "uk") return uk_common_readmore1(inputs)
	if (locale === "zh") return zh_common_readmore1(inputs)
	if (locale === "es") return es_common_readmore1(inputs)
	if (locale === "hi") return hi_common_readmore1(inputs)
	if (locale === "pt") return pt_common_readmore1(inputs)
	if (locale === "bn") return bn_common_readmore1(inputs)
	if (locale === "ru") return ru_common_readmore1(inputs)
	if (locale === "ja") return ja_common_readmore1(inputs)
	if (locale === "vi") return vi_common_readmore1(inputs)
	if (locale === "yue") return yue_common_readmore1(inputs)
	if (locale === "tr") return tr_common_readmore1(inputs)
	if (locale === "ar") return ar_common_readmore1(inputs)
	if (locale === "wuu") return wuu_common_readmore1(inputs)
	if (locale === "mr") return mr_common_readmore1(inputs)
	if (locale === "nb") return nb_common_readmore1(inputs)
	if (locale === "fi") return fi_common_readmore1(inputs)
	if (locale === "da") return da_common_readmore1(inputs)
	if (locale === "et") return et_common_readmore1(inputs)
	if (locale === "lv") return lv_common_readmore1(inputs)
	if (locale === "lt") return lt_common_readmore1(inputs)
	if (locale === "pl") return pl_common_readmore1(inputs)
	if (locale === "de") return de_common_readmore1(inputs)
	if (locale === "nl") return nl_common_readmore1(inputs)
	if (locale === "fr") return fr_common_readmore1(inputs)
	if (locale === "it") return it_common_readmore1(inputs)
	if (locale === "hu") return hu_common_readmore1(inputs)
	if (locale === "cs") return cs_common_readmore1(inputs)
	if (locale === "ro") return ro_common_readmore1(inputs)
	if (locale === "el") return el_common_readmore1(inputs)
	if (locale === "bg") return bg_common_readmore1(inputs)
	if (locale === "hr") return hr_common_readmore1(inputs)
	if (locale === "sr") return sr_common_readmore1(inputs)
	if (locale === "sk") return sk_common_readmore1(inputs)
	if (locale === "sl") return sl_common_readmore1(inputs)
	if (locale === "ko") return ko_common_readmore1(inputs)
	return en_common_readmore1(inputs)
});
