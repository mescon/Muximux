...
/** @typedef {{}} General_Navpositionfloatingdesc3Inputs */

const en_general_navpositionfloatingdesc3 = /** @type {(inputs: General_Navpositionfloatingdesc3Inputs) => LocalizedString} */ () => {
...
const ru_general_navpositionfloatingdesc3 = /** @type {(inputs: General_Navpositionfloatingdesc3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Минимальная плавающая кнопка`)
};
...
const ko_general_navpositionfloatingdesc3 = /** @type {(inputs: General_Navpositionfloatingdesc3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`최소화된 플로팅 버튼`)
};
...
const general_navpositionfloatingdesc3 = /** @type {((inputs?: General_Navpositionfloatingdesc3Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<General_Navpositionfloatingdesc3Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_general_navpositionfloatingdesc3(inputs)
	if (locale === "zh") return zh_general_navpositionfloatingdesc3(inputs)
	if (locale === "es") return es_general_navpositionfloatingdesc3(inputs)
	if (locale === "hi") return hi_general_navpositionfloatingdesc3(inputs)
	if (locale === "pt") return pt_general_navpositionfloatingdesc3(inputs)
	...
	if (locale === "ar") return ar_general_navpositionfloatingdesc3(inputs)
	if (locale === "wuu") return wuu_general_navpositionfloatingdesc3(inputs)
	if (locale === "mr") return mr_general_navpositionfloatingdesc3(inputs)
	if (locale === "nb") return nb_general_navpositionfloatingdesc3(inputs)
	if (locale === "fi") return fi_general_navpositionfloatingdesc3(inputs)
	if (locale === "da") return da_general_navpositionfloatingdesc3(inputs)
	if (locale === "et") return et_general_navpositionfloatingdesc3(inputs)
	if (locale === "lv") return lv_general_navpositionfloatingdesc3(inputs)
	if (locale === "lt") return lt_general_navpositionfloatingdesc3(inputs)
	if (locale === "pl") return pl_general_navpositionfloatingdesc3(inputs)
	if (locale === "de") return de_general_navpositionfloatingdesc3(inputs)
	if (locale === "nl") return nl_general_navpositionfloatingdesc3(inputs)
	if (locale === "fr") return fr_general_navpositionfloatingdesc3(inputs)
	if (locale === "it") return it_general_navpositionfloatingdesc3(inputs)
	if (locale === "hu") return hu_general_navpositionfloatingdesc3(inputs)
	if (locale === "cs") return cs_general_navpositionfloatingdesc3(inputs)
	if (locale === "ro") return ro_general_navpositionfloatingdesc3(inputs)
	if (locale === "el") return el_general_navpositionfloatingdesc3(inputs)
	if (locale === "bg") return bg_general_navpositionfloatingdesc3(inputs)
	if (locale === "hr") return hr_general_navpositionfloatingdesc3(inputs)
	if (locale === "sr") return sr_general_navpositionfloatingdesc3(inputs)
	if (locale === "sk") return sk_general_navpositionfloatingdesc3(inputs)
	if (locale === "sl") return sl_general_navpositionfloatingdesc3(inputs)
	if (locale === "ko") return ko_general_navpositionfloatingdesc3(inputs)
	return en_general_navpositionfloatingdesc3(inputs)
});
export { general_navpositionfloatingdesc3 as "general_navPositionFloatingDesc" }