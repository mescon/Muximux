...
/** @typedef {{}} Popularapps_Homeassistantdesc3Inputs */

const en_popularapps_homeassistantdesc3 = /** @type {(inputs: Popularapps_Homeassistantdesc3Inputs) => LocalizedString} */ () => {
...
const ru_popularapps_homeassistantdesc3 = /** @type {(inputs: Popularapps_Homeassistantdesc3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Домашняя автоматизация`)
};
...
const ko_popularapps_homeassistantdesc3 = /** @type {(inputs: Popularapps_Homeassistantdesc3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`홈 자동화`)
};
...
const popularapps_homeassistantdesc3 = /** @type {((inputs?: Popularapps_Homeassistantdesc3Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Popularapps_Homeassistantdesc3Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_popularapps_homeassistantdesc3(inputs)
	if (locale === "zh") return zh_popularapps_homeassistantdesc3(inputs)
	if (locale === "es") return es_popularapps_homeassistantdesc3(inputs)
	if (locale === "hi") return hi_popularapps_homeassistantdesc3(inputs)
	if (locale === "pt") return pt_popularapps_homeassistantdesc3(inputs)
	...
	if (locale === "ar") return ar_popularapps_homeassistantdesc3(inputs)
	if (locale === "wuu") return wuu_popularapps_homeassistantdesc3(inputs)
	if (locale === "mr") return mr_popularapps_homeassistantdesc3(inputs)
	if (locale === "nb") return nb_popularapps_homeassistantdesc3(inputs)
	if (locale === "fi") return fi_popularapps_homeassistantdesc3(inputs)
	if (locale === "da") return da_popularapps_homeassistantdesc3(inputs)
	if (locale === "et") return et_popularapps_homeassistantdesc3(inputs)
	if (locale === "lv") return lv_popularapps_homeassistantdesc3(inputs)
	if (locale === "lt") return lt_popularapps_homeassistantdesc3(inputs)
	if (locale === "pl") return pl_popularapps_homeassistantdesc3(inputs)
	if (locale === "de") return de_popularapps_homeassistantdesc3(inputs)
	if (locale === "nl") return nl_popularapps_homeassistantdesc3(inputs)
	if (locale === "fr") return fr_popularapps_homeassistantdesc3(inputs)
	if (locale === "it") return it_popularapps_homeassistantdesc3(inputs)
	if (locale === "hu") return hu_popularapps_homeassistantdesc3(inputs)
	if (locale === "cs") return cs_popularapps_homeassistantdesc3(inputs)
	if (locale === "ro") return ro_popularapps_homeassistantdesc3(inputs)
	if (locale === "el") return el_popularapps_homeassistantdesc3(inputs)
	if (locale === "bg") return bg_popularapps_homeassistantdesc3(inputs)
	if (locale === "hr") return hr_popularapps_homeassistantdesc3(inputs)
	if (locale === "sr") return sr_popularapps_homeassistantdesc3(inputs)
	if (locale === "sk") return sk_popularapps_homeassistantdesc3(inputs)
	if (locale === "sl") return sl_popularapps_homeassistantdesc3(inputs)
	if (locale === "ko") return ko_popularapps_homeassistantdesc3(inputs)
	return en_popularapps_homeassistantdesc3(inputs)
});
export { popularapps_homeassistantdesc3 as "popularApps_homeAssistantDesc" }