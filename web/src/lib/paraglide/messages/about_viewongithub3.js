...
/** @typedef {{}} About_Viewongithub3Inputs */

const en_about_viewongithub3 = /** @type {(inputs: About_Viewongithub3Inputs) => LocalizedString} */ () => {
...
const ru_about_viewongithub3 = /** @type {(inputs: About_Viewongithub3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Смотреть на GitHub`)
};
...
const ko_about_viewongithub3 = /** @type {(inputs: About_Viewongithub3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`GitHub에서 보기`)
};
...
const about_viewongithub3 = /** @type {((inputs?: About_Viewongithub3Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<About_Viewongithub3Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_about_viewongithub3(inputs)
	if (locale === "zh") return zh_about_viewongithub3(inputs)
	if (locale === "es") return es_about_viewongithub3(inputs)
	if (locale === "hi") return hi_about_viewongithub3(inputs)
	if (locale === "pt") return pt_about_viewongithub3(inputs)
	...
	if (locale === "ar") return ar_about_viewongithub3(inputs)
	if (locale === "wuu") return wuu_about_viewongithub3(inputs)
	if (locale === "mr") return mr_about_viewongithub3(inputs)
	if (locale === "nb") return nb_about_viewongithub3(inputs)
	if (locale === "fi") return fi_about_viewongithub3(inputs)
	if (locale === "da") return da_about_viewongithub3(inputs)
	if (locale === "et") return et_about_viewongithub3(inputs)
	if (locale === "lv") return lv_about_viewongithub3(inputs)
	if (locale === "lt") return lt_about_viewongithub3(inputs)
	if (locale === "pl") return pl_about_viewongithub3(inputs)
	if (locale === "de") return de_about_viewongithub3(inputs)
	if (locale === "nl") return nl_about_viewongithub3(inputs)
	if (locale === "fr") return fr_about_viewongithub3(inputs)
	if (locale === "it") return it_about_viewongithub3(inputs)
	if (locale === "hu") return hu_about_viewongithub3(inputs)
	if (locale === "cs") return cs_about_viewongithub3(inputs)
	if (locale === "ro") return ro_about_viewongithub3(inputs)
	if (locale === "el") return el_about_viewongithub3(inputs)
	if (locale === "bg") return bg_about_viewongithub3(inputs)
	if (locale === "hr") return hr_about_viewongithub3(inputs)
	if (locale === "sr") return sr_about_viewongithub3(inputs)
	if (locale === "sk") return sk_about_viewongithub3(inputs)
	if (locale === "sl") return sl_about_viewongithub3(inputs)
	if (locale === "ko") return ko_about_viewongithub3(inputs)
	return en_about_viewongithub3(inputs)
});
export { about_viewongithub3 as "about_viewOnGitHub" }