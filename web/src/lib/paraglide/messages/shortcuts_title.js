...
export const shortcuts_title = /** @type {((inputs?: Shortcuts_TitleInputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Shortcuts_TitleInputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_shortcuts_title(inputs)
	if (locale === "zh") return zh_shortcuts_title(inputs)
	if (locale === "es") return es_shortcuts_title(inputs)
	if (locale === "hi") return hi_shortcuts_title(inputs)
	if (locale === "pt") return pt_shortcuts_title(inputs)
	...
	if (locale === "ar") return ar_shortcuts_title(inputs)
	if (locale === "wuu") return wuu_shortcuts_title(inputs)
	if (locale === "mr") return mr_shortcuts_title(inputs)
	if (locale === "nb") return nb_shortcuts_title(inputs)
	if (locale === "fi") return fi_shortcuts_title(inputs)
	if (locale === "da") return da_shortcuts_title(inputs)
	if (locale === "et") return et_shortcuts_title(inputs)
	if (locale === "lv") return lv_shortcuts_title(inputs)
	if (locale === "lt") return lt_shortcuts_title(inputs)
	if (locale === "pl") return pl_shortcuts_title(inputs)
	if (locale === "de") return de_shortcuts_title(inputs)
	if (locale === "nl") return nl_shortcuts_title(inputs)
	if (locale === "fr") return fr_shortcuts_title(inputs)
	if (locale === "it") return it_shortcuts_title(inputs)
	if (locale === "hu") return hu_shortcuts_title(inputs)
	if (locale === "cs") return cs_shortcuts_title(inputs)
	if (locale === "ro") return ro_shortcuts_title(inputs)
	if (locale === "el") return el_shortcuts_title(inputs)
	if (locale === "bg") return bg_shortcuts_title(inputs)
	if (locale === "hr") return hr_shortcuts_title(inputs)
	if (locale === "sr") return sr_shortcuts_title(inputs)
	if (locale === "sk") return sk_shortcuts_title(inputs)
	if (locale === "sl") return sl_shortcuts_title(inputs)
	if (locale === "ko") return ko_shortcuts_title(inputs)
	return en_shortcuts_title(inputs)
});