...
const en_login_password = /** @type {(inputs: Login_PasswordInputs) => LocalizedString} */ () => {
...
const ko_login_password = /** @type {(inputs: Login_PasswordInputs) => LocalizedString} */ () => {
...
export const login_password = /** @type {((inputs?: Login_PasswordInputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Login_PasswordInputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_login_password(inputs)
	if (locale === "zh") return zh_login_password(inputs)
	if (locale === "es") return es_login_password(inputs)
	if (locale === "hi") return hi_login_password(inputs)
	if (locale === "pt") return pt_login_password(inputs)
	...
	if (locale === "ar") return ar_login_password(inputs)
	if (locale === "wuu") return wuu_login_password(inputs)
	if (locale === "mr") return mr_login_password(inputs)
	if (locale === "nb") return nb_login_password(inputs)
	if (locale === "fi") return fi_login_password(inputs)
	if (locale === "da") return da_login_password(inputs)
	if (locale === "et") return et_login_password(inputs)
	if (locale === "lv") return lv_login_password(inputs)
	if (locale === "lt") return lt_login_password(inputs)
	if (locale === "pl") return pl_login_password(inputs)
	if (locale === "de") return de_login_password(inputs)
	if (locale === "nl") return nl_login_password(inputs)
	if (locale === "fr") return fr_login_password(inputs)
	if (locale === "it") return it_login_password(inputs)
	if (locale === "hu") return hu_login_password(inputs)
	if (locale === "cs") return cs_login_password(inputs)
	if (locale === "ro") return ro_login_password(inputs)
	if (locale === "el") return el_login_password(inputs)
	if (locale === "bg") return bg_login_password(inputs)
	if (locale === "hr") return hr_login_password(inputs)
	if (locale === "sr") return sr_login_password(inputs)
	if (locale === "sk") return sk_login_password(inputs)
	if (locale === "sl") return sl_login_password(inputs)
	if (locale === "ko") return ko_login_password(inputs)
	return en_login_password(inputs)
});