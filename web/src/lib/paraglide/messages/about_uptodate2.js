...
/** @typedef {{}} About_Uptodate2Inputs */

const en_about_uptodate2 = /** @type {(inputs: About_Uptodate2Inputs) => LocalizedString} */ () => {
...
const ru_about_uptodate2 = /** @type {(inputs: About_Uptodate2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`У вас актуальная версия`)
};
...
const ko_about_uptodate2 = /** @type {(inputs: About_Uptodate2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`최신 버전을 사용 중입니다`)
};
...
const about_uptodate2 = /** @type {((inputs?: About_Uptodate2Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<About_Uptodate2Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_about_uptodate2(inputs)
	if (locale === "zh") return zh_about_uptodate2(inputs)
	if (locale === "es") return es_about_uptodate2(inputs)
	if (locale === "hi") return hi_about_uptodate2(inputs)
	if (locale === "pt") return pt_about_uptodate2(inputs)
	...
	if (locale === "ar") return ar_about_uptodate2(inputs)
	if (locale === "wuu") return wuu_about_uptodate2(inputs)
	if (locale === "mr") return mr_about_uptodate2(inputs)
	if (locale === "nb") return nb_about_uptodate2(inputs)
	if (locale === "fi") return fi_about_uptodate2(inputs)
	if (locale === "da") return da_about_uptodate2(inputs)
	if (locale === "et") return et_about_uptodate2(inputs)
	if (locale === "lv") return lv_about_uptodate2(inputs)
	if (locale === "lt") return lt_about_uptodate2(inputs)
	if (locale === "pl") return pl_about_uptodate2(inputs)
	if (locale === "de") return de_about_uptodate2(inputs)
	if (locale === "nl") return nl_about_uptodate2(inputs)
	if (locale === "fr") return fr_about_uptodate2(inputs)
	if (locale === "it") return it_about_uptodate2(inputs)
	if (locale === "hu") return hu_about_uptodate2(inputs)
	if (locale === "cs") return cs_about_uptodate2(inputs)
	if (locale === "ro") return ro_about_uptodate2(inputs)
	if (locale === "el") return el_about_uptodate2(inputs)
	if (locale === "bg") return bg_about_uptodate2(inputs)
	if (locale === "hr") return hr_about_uptodate2(inputs)
	if (locale === "sr") return sr_about_uptodate2(inputs)
	if (locale === "sk") return sk_about_uptodate2(inputs)
	if (locale === "sl") return sl_about_uptodate2(inputs)
	if (locale === "ko") return ko_about_uptodate2(inputs)
	return en_about_uptodate2(inputs)
});
export { about_uptodate2 as "about_upToDate" }