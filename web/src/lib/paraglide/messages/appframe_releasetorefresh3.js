...
/** @typedef {{}} Appframe_Releasetorefresh3Inputs */

const en_appframe_releasetorefresh3 = /** @type {(inputs: Appframe_Releasetorefresh3Inputs) => LocalizedString} */ () => {
...
const ko_appframe_releasetorefresh3 = /** @type {(inputs: Appframe_Releasetorefresh3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`놓으면 새로고침`)
};
...
const appframe_releasetorefresh3 = /** @type {((inputs?: Appframe_Releasetorefresh3Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Appframe_Releasetorefresh3Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "es") return es_appframe_releasetorefresh3(inputs)
	if (locale === "hi") return hi_appframe_releasetorefresh3(inputs)
	if (locale === "pt") return pt_appframe_releasetorefresh3(inputs)
	...
	if (locale === "ar") return ar_appframe_releasetorefresh3(inputs)
	if (locale === "wuu") return wuu_appframe_releasetorefresh3(inputs)
	if (locale === "mr") return mr_appframe_releasetorefresh3(inputs)
	if (locale === "nb") return nb_appframe_releasetorefresh3(inputs)
	if (locale === "fi") return fi_appframe_releasetorefresh3(inputs)
	if (locale === "da") return da_appframe_releasetorefresh3(inputs)
	if (locale === "et") return et_appframe_releasetorefresh3(inputs)
	if (locale === "lv") return lv_appframe_releasetorefresh3(inputs)
	if (locale === "lt") return lt_appframe_releasetorefresh3(inputs)
	if (locale === "pl") return pl_appframe_releasetorefresh3(inputs)
	if (locale === "de") return de_appframe_releasetorefresh3(inputs)
	if (locale === "nl") return nl_appframe_releasetorefresh3(inputs)
	if (locale === "fr") return fr_appframe_releasetorefresh3(inputs)
	if (locale === "it") return it_appframe_releasetorefresh3(inputs)
	if (locale === "hu") return hu_appframe_releasetorefresh3(inputs)
	if (locale === "cs") return cs_appframe_releasetorefresh3(inputs)
	if (locale === "ro") return ro_appframe_releasetorefresh3(inputs)
	if (locale === "el") return el_appframe_releasetorefresh3(inputs)
	if (locale === "bg") return bg_appframe_releasetorefresh3(inputs)
	if (locale === "hr") return hr_appframe_releasetorefresh3(inputs)
