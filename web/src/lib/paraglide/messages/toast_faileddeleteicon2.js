...
/** @typedef {{}} Toast_Faileddeleteicon2Inputs */

const en_toast_faileddeleteicon2 = /** @type {(inputs: Toast_Faileddeleteicon2Inputs) => LocalizedString} */ () => {
...
const ko_toast_faileddeleteicon2 = /** @type {(inputs: Toast_Faileddeleteicon2Inputs) => LocalizedString} */ () => {
...
const toast_faileddeleteicon2 = /** @type {((inputs?: Toast_Faileddeleteicon2Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Toast_Faileddeleteicon2Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_toast_faileddeleteicon2(inputs)
	if (locale === "zh") return zh_toast_faileddeleteicon2(inputs)
	if (locale === "es") return es_toast_faileddeleteicon2(inputs)
	if (locale === "hi") return hi_toast_faileddeleteicon2(inputs)
	if (locale === "pt") return pt_toast_faileddeleteicon2(inputs)
	...
	if (locale === "ar") return ar_toast_faileddeleteicon2(inputs)
	if (locale === "wuu") return wuu_toast_faileddeleteicon2(inputs)
	if (locale === "mr") return mr_toast_faileddeleteicon2(inputs)
	if (locale === "nb") return nb_toast_faileddeleteicon2(inputs)
	if (locale === "fi") return fi_toast_faileddeleteicon2(inputs)
	if (locale === "da") return da_toast_faileddeleteicon2(inputs)
	if (locale === "et") return et_toast_faileddeleteicon2(inputs)
	if (locale === "lv") return lv_toast_faileddeleteicon2(inputs)
	if (locale === "lt") return lt_toast_faileddeleteicon2(inputs)
	if (locale === "pl") return pl_toast_faileddeleteicon2(inputs)
	if (locale === "de") return de_toast_faileddeleteicon2(inputs)
	if (locale === "nl") return nl_toast_faileddeleteicon2(inputs)
	if (locale === "fr") return fr_toast_faileddeleteicon2(inputs)
	if (locale === "it") return it_toast_faileddeleteicon2(inputs)
	if (locale === "hu") return hu_toast_faileddeleteicon2(inputs)
	if (locale === "cs") return cs_toast_faileddeleteicon2(inputs)
	if (locale === "ro") return ro_toast_faileddeleteicon2(inputs)
	if (locale === "el") return el_toast_faileddeleteicon2(inputs)
	if (locale === "bg") return bg_toast_faileddeleteicon2(inputs)
	if (locale === "hr") return hr_toast_faileddeleteicon2(inputs)
	if (locale === "sr") return sr_toast_faileddeleteicon2(inputs)
	if (locale === "sk") return sk_toast_faileddeleteicon2(inputs)
	if (locale === "sl") return sl_toast_faileddeleteicon2(inputs)
	if (locale === "ko") return ko_toast_faileddeleteicon2(inputs)
	return en_toast_faileddeleteicon2(inputs)
});
export { toast_faileddeleteicon2 as "toast_failedDeleteIcon" }