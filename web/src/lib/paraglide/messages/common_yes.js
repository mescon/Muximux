...
const ko_common_yes = /** @type {(inputs: Common_YesInputs) => LocalizedString} */ () => {
...
export const common_yes = /** @type {((inputs?: Common_YesInputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Common_YesInputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "hi") return hi_common_yes(inputs)
	if (locale === "pt") return pt_common_yes(inputs)
	...
	if (locale === "ar") return ar_common_yes(inputs)
	if (locale === "wuu") return wuu_common_yes(inputs)
	if (locale === "mr") return mr_common_yes(inputs)
	if (locale === "nb") return nb_common_yes(inputs)
	if (locale === "fi") return fi_common_yes(inputs)
	if (locale === "da") return da_common_yes(inputs)
	if (locale === "et") return et_common_yes(inputs)
	if (locale === "lv") return lv_common_yes(inputs)
	if (locale === "lt") return lt_common_yes(inputs)
	if (locale === "pl") return pl_common_yes(inputs)
	if (locale === "de") return de_common_yes(inputs)
	if (locale === "nl") return nl_common_yes(inputs)
	if (locale === "fr") return fr_common_yes(inputs)
	if (locale === "it") return it_common_yes(inputs)
	if (locale === "hu") return hu_common_yes(inputs)
	if (locale === "cs") return cs_common_yes(inputs)
	if (locale === "ro") return ro_common_yes(inputs)
	if (locale === "el") return el_common_yes(inputs)
	if (locale === "bg") return bg_common_yes(inputs)
	if (locale === "hr") return hr_common_yes(inputs)
