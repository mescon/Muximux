...
const nl_logs_title = /** @type {(inputs: Logs_TitleInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Logs`)
};

const fr_logs_title = /** @type {(inputs: Logs_TitleInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Logs`)
};
...
const ko_logs_title = /** @type {(inputs: Logs_TitleInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`로그`)
};
...
export const logs_title = /** @type {((inputs?: Logs_TitleInputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Logs_TitleInputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_logs_title(inputs)
	if (locale === "zh") return zh_logs_title(inputs)
	if (locale === "es") return es_logs_title(inputs)
	if (locale === "hi") return hi_logs_title(inputs)
	if (locale === "pt") return pt_logs_title(inputs)
	...
	if (locale === "ar") return ar_logs_title(inputs)
	if (locale === "wuu") return wuu_logs_title(inputs)
	if (locale === "mr") return mr_logs_title(inputs)
	if (locale === "nb") return nb_logs_title(inputs)
	if (locale === "fi") return fi_logs_title(inputs)
	if (locale === "da") return da_logs_title(inputs)
	if (locale === "et") return et_logs_title(inputs)
	if (locale === "lv") return lv_logs_title(inputs)
	if (locale === "lt") return lt_logs_title(inputs)
	if (locale === "pl") return pl_logs_title(inputs)
	if (locale === "de") return de_logs_title(inputs)
	if (locale === "nl") return nl_logs_title(inputs)
	if (locale === "fr") return fr_logs_title(inputs)
	if (locale === "it") return it_logs_title(inputs)
	if (locale === "hu") return hu_logs_title(inputs)
	if (locale === "cs") return cs_logs_title(inputs)
	if (locale === "ro") return ro_logs_title(inputs)
	if (locale === "el") return el_logs_title(inputs)
	if (locale === "bg") return bg_logs_title(inputs)
	if (locale === "hr") return hr_logs_title(inputs)
	if (locale === "sr") return sr_logs_title(inputs)
	if (locale === "sk") return sk_logs_title(inputs)
	if (locale === "sl") return sl_logs_title(inputs)
	if (locale === "ko") return ko_logs_title(inputs)
