...
/** @typedef {{}} Iconbrowser_Dashboardicons2Inputs */

const en_iconbrowser_dashboardicons2 = /** @type {(inputs: Iconbrowser_Dashboardicons2Inputs) => LocalizedString} */ () => {
...
const pa_iconbrowser_dashboardicons2 = /** @type {(inputs: Iconbrowser_Dashboardicons2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Dashboard Icons`)
};
...
* | "Dashboard Icons" |
*
* @param {Iconbrowser_Dashboardicons2Inputs} inputs
* @param {{ locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "pa" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" }} options
* @returns {LocalizedString}
*/
const iconbrowser_dashboardicons2 = /** @type {((inputs?: Iconbrowser_Dashboardicons2Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "pa" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Iconbrowser_Dashboardicons2Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "pa" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_iconbrowser_dashboardicons2(inputs)
	if (locale === "sv") return sv_iconbrowser_dashboardicons2(inputs)
	if (locale === "uk") return uk_iconbrowser_dashboardicons2(inputs)
	if (locale === "zh") return zh_iconbrowser_dashboardicons2(inputs)
	if (locale === "es") return es_iconbrowser_dashboardicons2(inputs)
	if (locale === "hi") return hi_iconbrowser_dashboardicons2(inputs)
	if (locale === "pt") return pt_iconbrowser_dashboardicons2(inputs)
	if (locale === "bn") return bn_iconbrowser_dashboardicons2(inputs)
	if (locale === "ru") return ru_iconbrowser_dashboardicons2(inputs)
	if (locale === "ja") return ja_iconbrowser_dashboardicons2(inputs)
	if (locale === "pa") return pa_iconbrowser_dashboardicons2(inputs)
	if (locale === "vi") return vi_iconbrowser_dashboardicons2(inputs)
	if (locale === "yue") return yue_iconbrowser_dashboardicons2(inputs)
	if (locale === "tr") return tr_iconbrowser_dashboardicons2(inputs)
	if (locale === "ar") return ar_iconbrowser_dashboardicons2(inputs)
	if (locale === "wuu") return wuu_iconbrowser_dashboardicons2(inputs)
	if (locale === "mr") return mr_iconbrowser_dashboardicons2(inputs)
	if (locale === "nb") return nb_iconbrowser_dashboardicons2(inputs)
	if (locale === "fi") return fi_iconbrowser_dashboardicons2(inputs)
	if (locale === "da") return da_iconbrowser_dashboardicons2(inputs)
	if (locale === "et") return et_iconbrowser_dashboardicons2(inputs)
	if (locale === "lv") return lv_iconbrowser_dashboardicons2(inputs)
	if (locale === "lt") return lt_iconbrowser_dashboardicons2(inputs)
	if (locale === "pl") return pl_iconbrowser_dashboardicons2(inputs)
	if (locale === "de") return de_iconbrowser_dashboardicons2(inputs)
	if (locale === "nl") return nl_iconbrowser_dashboardicons2(inputs)
	if (locale === "fr") return fr_iconbrowser_dashboardicons2(inputs)
	if (locale === "it") return it_iconbrowser_dashboardicons2(inputs)
	if (locale === "hu") return hu_iconbrowser_dashboardicons2(inputs)
	if (locale === "cs") return cs_iconbrowser_dashboardicons2(inputs)
	if (locale === "ro") return ro_iconbrowser_dashboardicons2(inputs)
	if (locale === "el") return el_iconbrowser_dashboardicons2(inputs)
	if (locale === "bg") return bg_iconbrowser_dashboardicons2(inputs)
	if (locale === "hr") return hr_iconbrowser_dashboardicons2(inputs)
	if (locale === "sr") return sr_iconbrowser_dashboardicons2(inputs)
	if (locale === "sk") return sk_iconbrowser_dashboardicons2(inputs)
	return sl_iconbrowser_dashboardicons2(inputs)
});
export { iconbrowser_dashboardicons2 as "iconBrowser_dashboardIcons" }