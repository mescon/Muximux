...
/** @typedef {{}} Appframe_Pulltorefresh3Inputs */

const en_appframe_pulltorefresh3 = /** @type {(inputs: Appframe_Pulltorefresh3Inputs) => LocalizedString} */ () => {
...
const ko_appframe_pulltorefresh3 = /** @type {(inputs: Appframe_Pulltorefresh3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`당겨서 새로고침`)
};
...
const appframe_pulltorefresh3 = /** @type {((inputs?: Appframe_Pulltorefresh3Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Appframe_Pulltorefresh3Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_appframe_pulltorefresh3(inputs)
	if (locale === "zh") return zh_appframe_pulltorefresh3(inputs)
	if (locale === "es") return es_appframe_pulltorefresh3(inputs)
	if (locale === "hi") return hi_appframe_pulltorefresh3(inputs)
	if (locale === "pt") return pt_appframe_pulltorefresh3(inputs)
	...
	if (locale === "ar") return ar_appframe_pulltorefresh3(inputs)
	if (locale === "wuu") return wuu_appframe_pulltorefresh3(inputs)
	if (locale === "mr") return mr_appframe_pulltorefresh3(inputs)
	if (locale === "nb") return nb_appframe_pulltorefresh3(inputs)
	if (locale === "fi") return fi_appframe_pulltorefresh3(inputs)
	if (locale === "da") return da_appframe_pulltorefresh3(inputs)
	if (locale === "et") return et_appframe_pulltorefresh3(inputs)
	if (locale === "lv") return lv_appframe_pulltorefresh3(inputs)
	if (locale === "lt") return lt_appframe_pulltorefresh3(inputs)
	if (locale === "pl") return pl_appframe_pulltorefresh3(inputs)
	if (locale === "de") return de_appframe_pulltorefresh3(inputs)
	if (locale === "nl") return nl_appframe_pulltorefresh3(inputs)
	if (locale === "fr") return fr_appframe_pulltorefresh3(inputs)
	if (locale === "it") return it_appframe_pulltorefresh3(inputs)
	if (locale === "hu") return hu_appframe_pulltorefresh3(inputs)
	if (locale === "cs") return cs_appframe_pulltorefresh3(inputs)
	if (locale === "ro") return ro_appframe_pulltorefresh3(inputs)
	if (locale === "el") return el_appframe_pulltorefresh3(inputs)
	if (locale === "bg") return bg_appframe_pulltorefresh3(inputs)
	if (locale === "hr") return hr_appframe_pulltorefresh3(inputs)
	if (locale === "sr") return sr_appframe_pulltorefresh3(inputs)
	if (locale === "sk") return sk_appframe_pulltorefresh3(inputs)
	if (locale === "sl") return sl_appframe_pulltorefresh3(inputs)
	if (locale === "ko") return ko_appframe_pulltorefresh3(inputs)
	return en_appframe_pulltorefresh3(inputs)
});
export { appframe_pulltorefresh3 as "appFrame_pullToRefresh" }