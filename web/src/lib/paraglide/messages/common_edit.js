...
export const common_edit = /** @type {((inputs?: Common_EditInputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Common_EditInputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "pt") return pt_common_edit(inputs)
	...
	if (locale === "ar") return ar_common_edit(inputs)
	if (locale === "wuu") return wuu_common_edit(inputs)
	if (locale === "mr") return mr_common_edit(inputs)
	if (locale === "nb") return nb_common_edit(inputs)
	if (locale === "fi") return fi_common_edit(inputs)
	if (locale === "da") return da_common_edit(inputs)
	if (locale === "et") return et_common_edit(inputs)
	if (locale === "lv") return lv_common_edit(inputs)
	if (locale === "lt") return lt_common_edit(inputs)
	if (locale === "pl") return pl_common_edit(inputs)
	if (locale === "de") return de_common_edit(inputs)
	if (locale === "nl") return nl_common_edit(inputs)
	if (locale === "fr") return fr_common_edit(inputs)
	if (locale === "it") return it_common_edit(inputs)
	if (locale === "hu") return hu_common_edit(inputs)
	if (locale === "cs") return cs_common_edit(inputs)
	if (locale === "ro") return ro_common_edit(inputs)
	if (locale === "el") return el_common_edit(inputs)
	if (locale === "bg") return bg_common_edit(inputs)
	if (locale === "hr") return hr_common_edit(inputs)
