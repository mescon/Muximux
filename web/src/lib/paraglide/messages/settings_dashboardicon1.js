...
/** @typedef {{}} Settings_Dashboardicon1Inputs */

const en_settings_dashboardicon1 = /** @type {(inputs: Settings_Dashboardicon1Inputs) => LocalizedString} */ () => {
...
const ko_settings_dashboardicon1 = /** @type {(inputs: Settings_Dashboardicon1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Dashboard Icon`)
};
...
const settings_dashboardicon1 = /** @type {((inputs?: Settings_Dashboardicon1Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Settings_Dashboardicon1Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_settings_dashboardicon1(inputs)
	if (locale === "zh") return zh_settings_dashboardicon1(inputs)
	if (locale === "es") return es_settings_dashboardicon1(inputs)
	if (locale === "hi") return hi_settings_dashboardicon1(inputs)
	if (locale === "pt") return pt_settings_dashboardicon1(inputs)
	...
	if (locale === "ar") return ar_settings_dashboardicon1(inputs)
	if (locale === "wuu") return wuu_settings_dashboardicon1(inputs)
	if (locale === "mr") return mr_settings_dashboardicon1(inputs)
	if (locale === "nb") return nb_settings_dashboardicon1(inputs)
	if (locale === "fi") return fi_settings_dashboardicon1(inputs)
	if (locale === "da") return da_settings_dashboardicon1(inputs)
	if (locale === "et") return et_settings_dashboardicon1(inputs)
	if (locale === "lv") return lv_settings_dashboardicon1(inputs)
	if (locale === "lt") return lt_settings_dashboardicon1(inputs)
	if (locale === "pl") return pl_settings_dashboardicon1(inputs)
	if (locale === "de") return de_settings_dashboardicon1(inputs)
	if (locale === "nl") return nl_settings_dashboardicon1(inputs)
	if (locale === "fr") return fr_settings_dashboardicon1(inputs)
	if (locale === "it") return it_settings_dashboardicon1(inputs)
	if (locale === "hu") return hu_settings_dashboardicon1(inputs)
	if (locale === "cs") return cs_settings_dashboardicon1(inputs)
	if (locale === "ro") return ro_settings_dashboardicon1(inputs)
	if (locale === "el") return el_settings_dashboardicon1(inputs)
	if (locale === "bg") return bg_settings_dashboardicon1(inputs)
	if (locale === "hr") return hr_settings_dashboardicon1(inputs)
	if (locale === "sr") return sr_settings_dashboardicon1(inputs)
	if (locale === "sk") return sk_settings_dashboardicon1(inputs)
	if (locale === "sl") return sl_settings_dashboardicon1(inputs)
	if (locale === "ko") return ko_settings_dashboardicon1(inputs)
	return en_settings_dashboardicon1(inputs)
});
export { settings_dashboardicon1 as "settings_dashboardIcon" }