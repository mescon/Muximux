...
/** @typedef {{}} Settings_ColorInputs */

const en_settings_color = /** @type {(inputs: Settings_ColorInputs) => LocalizedString} */ () => {
...
const ko_settings_color = /** @type {(inputs: Settings_ColorInputs) => LocalizedString} */ () => {
...
export const settings_color = /** @type {((inputs?: Settings_ColorInputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Settings_ColorInputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_settings_color(inputs)
	if (locale === "zh") return zh_settings_color(inputs)
	if (locale === "es") return es_settings_color(inputs)
	if (locale === "hi") return hi_settings_color(inputs)
	if (locale === "pt") return pt_settings_color(inputs)
	...
	if (locale === "ar") return ar_settings_color(inputs)
	if (locale === "wuu") return wuu_settings_color(inputs)
	if (locale === "mr") return mr_settings_color(inputs)
	if (locale === "nb") return nb_settings_color(inputs)
	if (locale === "fi") return fi_settings_color(inputs)
	if (locale === "da") return da_settings_color(inputs)
	if (locale === "et") return et_settings_color(inputs)
	if (locale === "lv") return lv_settings_color(inputs)
	if (locale === "lt") return lt_settings_color(inputs)
	if (locale === "pl") return pl_settings_color(inputs)
	if (locale === "de") return de_settings_color(inputs)
	if (locale === "nl") return nl_settings_color(inputs)
	if (locale === "fr") return fr_settings_color(inputs)
	if (locale === "it") return it_settings_color(inputs)
	if (locale === "hu") return hu_settings_color(inputs)
	if (locale === "cs") return cs_settings_color(inputs)
	if (locale === "ro") return ro_settings_color(inputs)
	if (locale === "el") return el_settings_color(inputs)
	if (locale === "bg") return bg_settings_color(inputs)
	if (locale === "hr") return hr_settings_color(inputs)
	if (locale === "sr") return sr_settings_color(inputs)
	if (locale === "sk") return sk_settings_color(inputs)
	if (locale === "sl") return sl_settings_color(inputs)
	if (locale === "ko") return ko_settings_color(inputs)
	return en_settings_color(inputs)
});