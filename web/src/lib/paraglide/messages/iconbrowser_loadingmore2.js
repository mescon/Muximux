...
/** @typedef {{ current: NonNullable<unknown>, total: NonNullable<unknown> }} Iconbrowser_Loadingmore2Inputs */

const en_iconbrowser_loadingmore2 = /** @type {(inputs: Iconbrowser_Loadingmore2Inputs) => LocalizedString} */ (i) => {
...
const ko_iconbrowser_loadingmore2 = /** @type {(inputs: Iconbrowser_Loadingmore2Inputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`더 불러오는 중... (${i?.current}/${i?.total})`)
};
...
const iconbrowser_loadingmore2 = /** @type {((inputs: Iconbrowser_Loadingmore2Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Iconbrowser_Loadingmore2Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs, options = {}) => {
	...
	if (locale === "uk") return uk_iconbrowser_loadingmore2(inputs)
	if (locale === "zh") return zh_iconbrowser_loadingmore2(inputs)
	if (locale === "es") return es_iconbrowser_loadingmore2(inputs)
	if (locale === "hi") return hi_iconbrowser_loadingmore2(inputs)
	if (locale === "pt") return pt_iconbrowser_loadingmore2(inputs)
	...
	if (locale === "ar") return ar_iconbrowser_loadingmore2(inputs)
	if (locale === "wuu") return wuu_iconbrowser_loadingmore2(inputs)
	if (locale === "mr") return mr_iconbrowser_loadingmore2(inputs)
	if (locale === "nb") return nb_iconbrowser_loadingmore2(inputs)
	if (locale === "fi") return fi_iconbrowser_loadingmore2(inputs)
	if (locale === "da") return da_iconbrowser_loadingmore2(inputs)
	if (locale === "et") return et_iconbrowser_loadingmore2(inputs)
	if (locale === "lv") return lv_iconbrowser_loadingmore2(inputs)
	if (locale === "lt") return lt_iconbrowser_loadingmore2(inputs)
	if (locale === "pl") return pl_iconbrowser_loadingmore2(inputs)
	if (locale === "de") return de_iconbrowser_loadingmore2(inputs)
	if (locale === "nl") return nl_iconbrowser_loadingmore2(inputs)
	if (locale === "fr") return fr_iconbrowser_loadingmore2(inputs)
	if (locale === "it") return it_iconbrowser_loadingmore2(inputs)
	if (locale === "hu") return hu_iconbrowser_loadingmore2(inputs)
	if (locale === "cs") return cs_iconbrowser_loadingmore2(inputs)
	if (locale === "ro") return ro_iconbrowser_loadingmore2(inputs)
	if (locale === "el") return el_iconbrowser_loadingmore2(inputs)
	if (locale === "bg") return bg_iconbrowser_loadingmore2(inputs)
	if (locale === "hr") return hr_iconbrowser_loadingmore2(inputs)
	if (locale === "sr") return sr_iconbrowser_loadingmore2(inputs)
	if (locale === "sk") return sk_iconbrowser_loadingmore2(inputs)
	if (locale === "sl") return sl_iconbrowser_loadingmore2(inputs)
	if (locale === "ko") return ko_iconbrowser_loadingmore2(inputs)
	return en_iconbrowser_loadingmore2(inputs)
});
export { iconbrowser_loadingmore2 as "iconBrowser_loadingMore" }