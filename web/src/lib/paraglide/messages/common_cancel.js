...
export const common_cancel = /** @type {((inputs?: Common_CancelInputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Common_CancelInputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_common_cancel(inputs)
	...
	if (locale === "ar") return ar_common_cancel(inputs)
	if (locale === "wuu") return wuu_common_cancel(inputs)
	if (locale === "mr") return mr_common_cancel(inputs)
	if (locale === "nb") return nb_common_cancel(inputs)
	if (locale === "fi") return fi_common_cancel(inputs)
	if (locale === "da") return da_common_cancel(inputs)
	if (locale === "et") return et_common_cancel(inputs)
	if (locale === "lv") return lv_common_cancel(inputs)
	if (locale === "lt") return lt_common_cancel(inputs)
	if (locale === "pl") return pl_common_cancel(inputs)
	if (locale === "de") return de_common_cancel(inputs)
	if (locale === "nl") return nl_common_cancel(inputs)
	if (locale === "fr") return fr_common_cancel(inputs)
	if (locale === "it") return it_common_cancel(inputs)
	if (locale === "hu") return hu_common_cancel(inputs)
	if (locale === "cs") return cs_common_cancel(inputs)
	if (locale === "ro") return ro_common_cancel(inputs)
	if (locale === "el") return el_common_cancel(inputs)
	if (locale === "bg") return bg_common_cancel(inputs)
	if (locale === "hr") return hr_common_cancel(inputs)
	if (locale === "sr") return sr_common_cancel(inputs)
	if (locale === "sk") return sk_common_cancel(inputs)
	if (locale === "sl") return sl_common_cancel(inputs)
