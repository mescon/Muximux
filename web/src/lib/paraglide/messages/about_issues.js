...
/** @typedef {{}} About_IssuesInputs */

const en_about_issues = /** @type {(inputs: About_IssuesInputs) => LocalizedString} */ () => {
...
const nl_about_issues = /** @type {(inputs: About_IssuesInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Issues`)
};

const fr_about_issues = /** @type {(inputs: About_IssuesInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Issues`)
};

const it_about_issues = /** @type {(inputs: About_IssuesInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Issues`)
};
...
const ko_about_issues = /** @type {(inputs: About_IssuesInputs) => LocalizedString} */ () => {
...
export const about_issues = /** @type {((inputs?: About_IssuesInputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<About_IssuesInputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_about_issues(inputs)
	if (locale === "zh") return zh_about_issues(inputs)
	if (locale === "es") return es_about_issues(inputs)
	if (locale === "hi") return hi_about_issues(inputs)
	if (locale === "pt") return pt_about_issues(inputs)
	...
	if (locale === "ar") return ar_about_issues(inputs)
	if (locale === "wuu") return wuu_about_issues(inputs)
	if (locale === "mr") return mr_about_issues(inputs)
	if (locale === "nb") return nb_about_issues(inputs)
	if (locale === "fi") return fi_about_issues(inputs)
	if (locale === "da") return da_about_issues(inputs)
	if (locale === "et") return et_about_issues(inputs)
	if (locale === "lv") return lv_about_issues(inputs)
	if (locale === "lt") return lt_about_issues(inputs)
	if (locale === "pl") return pl_about_issues(inputs)
	if (locale === "de") return de_about_issues(inputs)
	if (locale === "nl") return nl_about_issues(inputs)
	if (locale === "fr") return fr_about_issues(inputs)
	if (locale === "it") return it_about_issues(inputs)
	if (locale === "hu") return hu_about_issues(inputs)
	if (locale === "cs") return cs_about_issues(inputs)
	if (locale === "ro") return ro_about_issues(inputs)
	if (locale === "el") return el_about_issues(inputs)
	if (locale === "bg") return bg_about_issues(inputs)
	if (locale === "hr") return hr_about_issues(inputs)
	if (locale === "sr") return sr_about_issues(inputs)
	if (locale === "sk") return sk_about_issues(inputs)
	if (locale === "sl") return sl_about_issues(inputs)
	if (locale === "ko") return ko_about_issues(inputs)
	return en_about_issues(inputs)
});