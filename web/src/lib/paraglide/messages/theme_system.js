...
const sv_theme_system = /** @type {(inputs: Theme_SystemInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`System`)
};
...
const ko_theme_system = /** @type {(inputs: Theme_SystemInputs) => LocalizedString} */ () => {
...
export const theme_system = /** @type {((inputs?: Theme_SystemInputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Theme_SystemInputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "es") return es_theme_system(inputs)
	if (locale === "hi") return hi_theme_system(inputs)
	if (locale === "pt") return pt_theme_system(inputs)
	...
	if (locale === "ar") return ar_theme_system(inputs)
	if (locale === "wuu") return wuu_theme_system(inputs)
	if (locale === "mr") return mr_theme_system(inputs)
	if (locale === "nb") return nb_theme_system(inputs)
	if (locale === "fi") return fi_theme_system(inputs)
	if (locale === "da") return da_theme_system(inputs)
	if (locale === "et") return et_theme_system(inputs)
	if (locale === "lv") return lv_theme_system(inputs)
	if (locale === "lt") return lt_theme_system(inputs)
	if (locale === "pl") return pl_theme_system(inputs)
	if (locale === "de") return de_theme_system(inputs)
	if (locale === "nl") return nl_theme_system(inputs)
	if (locale === "fr") return fr_theme_system(inputs)
	if (locale === "it") return it_theme_system(inputs)
	if (locale === "hu") return hu_theme_system(inputs)
	if (locale === "cs") return cs_theme_system(inputs)
	if (locale === "ro") return ro_theme_system(inputs)
	if (locale === "el") return el_theme_system(inputs)
	if (locale === "bg") return bg_theme_system(inputs)
	if (locale === "hr") return hr_theme_system(inputs)
