...
/** @typedef {{}} Popularapps_Radarrdesc2Inputs */

const en_popularapps_radarrdesc2 = /** @type {(inputs: Popularapps_Radarrdesc2Inputs) => LocalizedString} */ () => {
...
const ko_popularapps_radarrdesc2 = /** @type {(inputs: Popularapps_Radarrdesc2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`영화 관리`)
};
...
const popularapps_radarrdesc2 = /** @type {((inputs?: Popularapps_Radarrdesc2Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Popularapps_Radarrdesc2Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_popularapps_radarrdesc2(inputs)
	if (locale === "zh") return zh_popularapps_radarrdesc2(inputs)
	if (locale === "es") return es_popularapps_radarrdesc2(inputs)
	if (locale === "hi") return hi_popularapps_radarrdesc2(inputs)
	if (locale === "pt") return pt_popularapps_radarrdesc2(inputs)
	...
	if (locale === "ar") return ar_popularapps_radarrdesc2(inputs)
	if (locale === "wuu") return wuu_popularapps_radarrdesc2(inputs)
	if (locale === "mr") return mr_popularapps_radarrdesc2(inputs)
	if (locale === "nb") return nb_popularapps_radarrdesc2(inputs)
	if (locale === "fi") return fi_popularapps_radarrdesc2(inputs)
	if (locale === "da") return da_popularapps_radarrdesc2(inputs)
	if (locale === "et") return et_popularapps_radarrdesc2(inputs)
	if (locale === "lv") return lv_popularapps_radarrdesc2(inputs)
	if (locale === "lt") return lt_popularapps_radarrdesc2(inputs)
	if (locale === "pl") return pl_popularapps_radarrdesc2(inputs)
	if (locale === "de") return de_popularapps_radarrdesc2(inputs)
	if (locale === "nl") return nl_popularapps_radarrdesc2(inputs)
	if (locale === "fr") return fr_popularapps_radarrdesc2(inputs)
	if (locale === "it") return it_popularapps_radarrdesc2(inputs)
	if (locale === "hu") return hu_popularapps_radarrdesc2(inputs)
	if (locale === "cs") return cs_popularapps_radarrdesc2(inputs)
	if (locale === "ro") return ro_popularapps_radarrdesc2(inputs)
	if (locale === "el") return el_popularapps_radarrdesc2(inputs)
	if (locale === "bg") return bg_popularapps_radarrdesc2(inputs)
	if (locale === "hr") return hr_popularapps_radarrdesc2(inputs)
	if (locale === "sr") return sr_popularapps_radarrdesc2(inputs)
	if (locale === "sk") return sk_popularapps_radarrdesc2(inputs)
	if (locale === "sl") return sl_popularapps_radarrdesc2(inputs)
	if (locale === "ko") return ko_popularapps_radarrdesc2(inputs)
	return en_popularapps_radarrdesc2(inputs)
});
export { popularapps_radarrdesc2 as "popularApps_radarrDesc" }