...
/** @typedef {{}} Nav_RefreshInputs */

const en_nav_refresh = /** @type {(inputs: Nav_RefreshInputs) => LocalizedString} */ () => {
...
const ko_nav_refresh = /** @type {(inputs: Nav_RefreshInputs) => LocalizedString} */ () => {
...
export const nav_refresh = /** @type {((inputs?: Nav_RefreshInputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Nav_RefreshInputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_nav_refresh(inputs)
	if (locale === "zh") return zh_nav_refresh(inputs)
	if (locale === "es") return es_nav_refresh(inputs)
	if (locale === "hi") return hi_nav_refresh(inputs)
	if (locale === "pt") return pt_nav_refresh(inputs)
	...
	if (locale === "ar") return ar_nav_refresh(inputs)
	if (locale === "wuu") return wuu_nav_refresh(inputs)
	if (locale === "mr") return mr_nav_refresh(inputs)
	if (locale === "nb") return nb_nav_refresh(inputs)
	if (locale === "fi") return fi_nav_refresh(inputs)
	if (locale === "da") return da_nav_refresh(inputs)
	if (locale === "et") return et_nav_refresh(inputs)
	if (locale === "lv") return lv_nav_refresh(inputs)
	if (locale === "lt") return lt_nav_refresh(inputs)
	if (locale === "pl") return pl_nav_refresh(inputs)
	if (locale === "de") return de_nav_refresh(inputs)
	if (locale === "nl") return nl_nav_refresh(inputs)
	if (locale === "fr") return fr_nav_refresh(inputs)
	if (locale === "it") return it_nav_refresh(inputs)
	if (locale === "hu") return hu_nav_refresh(inputs)
	if (locale === "cs") return cs_nav_refresh(inputs)
	if (locale === "ro") return ro_nav_refresh(inputs)
	if (locale === "el") return el_nav_refresh(inputs)
	if (locale === "bg") return bg_nav_refresh(inputs)
	if (locale === "hr") return hr_nav_refresh(inputs)
	if (locale === "sr") return sr_nav_refresh(inputs)
	if (locale === "sk") return sk_nav_refresh(inputs)
	if (locale === "sl") return sl_nav_refresh(inputs)
	if (locale === "ko") return ko_nav_refresh(inputs)
	return en_nav_refresh(inputs)
});