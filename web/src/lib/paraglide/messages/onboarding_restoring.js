...
/** @typedef {{}} Onboarding_RestoringInputs */

const en_onboarding_restoring = /** @type {(inputs: Onboarding_RestoringInputs) => LocalizedString} */ () => {
...
const ko_onboarding_restoring = /** @type {(inputs: Onboarding_RestoringInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`복원 중...`)
};
...
export const onboarding_restoring = /** @type {((inputs?: Onboarding_RestoringInputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Onboarding_RestoringInputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "es") return es_onboarding_restoring(inputs)
	if (locale === "hi") return hi_onboarding_restoring(inputs)
	if (locale === "pt") return pt_onboarding_restoring(inputs)
	...
	if (locale === "ar") return ar_onboarding_restoring(inputs)
	if (locale === "wuu") return wuu_onboarding_restoring(inputs)
	if (locale === "mr") return mr_onboarding_restoring(inputs)
	if (locale === "nb") return nb_onboarding_restoring(inputs)
	if (locale === "fi") return fi_onboarding_restoring(inputs)
	if (locale === "da") return da_onboarding_restoring(inputs)
	if (locale === "et") return et_onboarding_restoring(inputs)
	if (locale === "lv") return lv_onboarding_restoring(inputs)
	if (locale === "lt") return lt_onboarding_restoring(inputs)
	if (locale === "pl") return pl_onboarding_restoring(inputs)
	if (locale === "de") return de_onboarding_restoring(inputs)
	if (locale === "nl") return nl_onboarding_restoring(inputs)
	if (locale === "fr") return fr_onboarding_restoring(inputs)
	if (locale === "it") return it_onboarding_restoring(inputs)
	if (locale === "hu") return hu_onboarding_restoring(inputs)
	if (locale === "cs") return cs_onboarding_restoring(inputs)
	if (locale === "ro") return ro_onboarding_restoring(inputs)
	if (locale === "el") return el_onboarding_restoring(inputs)
	if (locale === "bg") return bg_onboarding_restoring(inputs)
	if (locale === "hr") return hr_onboarding_restoring(inputs)
