...
/** @typedef {{}} Security_Trustedproxies1Inputs */

const en_security_trustedproxies1 = /** @type {(inputs: Security_Trustedproxies1Inputs) => LocalizedString} */ () => {
...
const ru_security_trustedproxies1 = /** @type {(inputs: Security_Trustedproxies1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Доверенные IP-адреса прокси`)
};
...
const ko_security_trustedproxies1 = /** @type {(inputs: Security_Trustedproxies1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`신뢰할 프록시 IP`)
};
...
const security_trustedproxies1 = /** @type {((inputs?: Security_Trustedproxies1Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Security_Trustedproxies1Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_security_trustedproxies1(inputs)
	if (locale === "zh") return zh_security_trustedproxies1(inputs)
	if (locale === "es") return es_security_trustedproxies1(inputs)
	if (locale === "hi") return hi_security_trustedproxies1(inputs)
	if (locale === "pt") return pt_security_trustedproxies1(inputs)
	...
	if (locale === "ar") return ar_security_trustedproxies1(inputs)
	if (locale === "wuu") return wuu_security_trustedproxies1(inputs)
	if (locale === "mr") return mr_security_trustedproxies1(inputs)
	if (locale === "nb") return nb_security_trustedproxies1(inputs)
	if (locale === "fi") return fi_security_trustedproxies1(inputs)
	if (locale === "da") return da_security_trustedproxies1(inputs)
	if (locale === "et") return et_security_trustedproxies1(inputs)
	if (locale === "lv") return lv_security_trustedproxies1(inputs)
	if (locale === "lt") return lt_security_trustedproxies1(inputs)
	if (locale === "pl") return pl_security_trustedproxies1(inputs)
	if (locale === "de") return de_security_trustedproxies1(inputs)
	if (locale === "nl") return nl_security_trustedproxies1(inputs)
	if (locale === "fr") return fr_security_trustedproxies1(inputs)
	if (locale === "it") return it_security_trustedproxies1(inputs)
	if (locale === "hu") return hu_security_trustedproxies1(inputs)
	if (locale === "cs") return cs_security_trustedproxies1(inputs)
	if (locale === "ro") return ro_security_trustedproxies1(inputs)
	if (locale === "el") return el_security_trustedproxies1(inputs)
	if (locale === "bg") return bg_security_trustedproxies1(inputs)
	if (locale === "hr") return hr_security_trustedproxies1(inputs)
	if (locale === "sr") return sr_security_trustedproxies1(inputs)
	if (locale === "sk") return sk_security_trustedproxies1(inputs)
	if (locale === "sl") return sl_security_trustedproxies1(inputs)
	if (locale === "ko") return ko_security_trustedproxies1(inputs)
	return en_security_trustedproxies1(inputs)
});
export { security_trustedproxies1 as "security_trustedProxies" }