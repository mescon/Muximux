...
/** @typedef {{}} Keybindings_Addalternative1Inputs */

const en_keybindings_addalternative1 = /** @type {(inputs: Keybindings_Addalternative1Inputs) => LocalizedString} */ () => {
...
const ko_keybindings_addalternative1 = /** @type {(inputs: Keybindings_Addalternative1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`대체 단축키 추가`)
};
...
const keybindings_addalternative1 = /** @type {((inputs?: Keybindings_Addalternative1Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Keybindings_Addalternative1Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_keybindings_addalternative1(inputs)
	if (locale === "zh") return zh_keybindings_addalternative1(inputs)
	if (locale === "es") return es_keybindings_addalternative1(inputs)
	if (locale === "hi") return hi_keybindings_addalternative1(inputs)
	if (locale === "pt") return pt_keybindings_addalternative1(inputs)
	...
	if (locale === "ar") return ar_keybindings_addalternative1(inputs)
	if (locale === "wuu") return wuu_keybindings_addalternative1(inputs)
	if (locale === "mr") return mr_keybindings_addalternative1(inputs)
	if (locale === "nb") return nb_keybindings_addalternative1(inputs)
	if (locale === "fi") return fi_keybindings_addalternative1(inputs)
	if (locale === "da") return da_keybindings_addalternative1(inputs)
	if (locale === "et") return et_keybindings_addalternative1(inputs)
	if (locale === "lv") return lv_keybindings_addalternative1(inputs)
	if (locale === "lt") return lt_keybindings_addalternative1(inputs)
	if (locale === "pl") return pl_keybindings_addalternative1(inputs)
	if (locale === "de") return de_keybindings_addalternative1(inputs)
	if (locale === "nl") return nl_keybindings_addalternative1(inputs)
	if (locale === "fr") return fr_keybindings_addalternative1(inputs)
	if (locale === "it") return it_keybindings_addalternative1(inputs)
	if (locale === "hu") return hu_keybindings_addalternative1(inputs)
	if (locale === "cs") return cs_keybindings_addalternative1(inputs)
	if (locale === "ro") return ro_keybindings_addalternative1(inputs)
	if (locale === "el") return el_keybindings_addalternative1(inputs)
	if (locale === "bg") return bg_keybindings_addalternative1(inputs)
	if (locale === "hr") return hr_keybindings_addalternative1(inputs)
	if (locale === "sr") return sr_keybindings_addalternative1(inputs)
	if (locale === "sk") return sk_keybindings_addalternative1(inputs)
	if (locale === "sl") return sl_keybindings_addalternative1(inputs)
	if (locale === "ko") return ko_keybindings_addalternative1(inputs)
	return en_keybindings_addalternative1(inputs)
});
export { keybindings_addalternative1 as "keybindings_addAlternative" }