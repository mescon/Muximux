...
/** @typedef {{}} Security_Userheader1Inputs */

const en_security_userheader1 = /** @type {(inputs: Security_Userheader1Inputs) => LocalizedString} */ () => {
...
const ko_security_userheader1 = /** @type {(inputs: Security_Userheader1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`사용자 헤더`)
};
...
const security_userheader1 = /** @type {((inputs?: Security_Userheader1Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Security_Userheader1Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_security_userheader1(inputs)
	if (locale === "zh") return zh_security_userheader1(inputs)
	if (locale === "es") return es_security_userheader1(inputs)
	if (locale === "hi") return hi_security_userheader1(inputs)
	if (locale === "pt") return pt_security_userheader1(inputs)
	...
	if (locale === "ar") return ar_security_userheader1(inputs)
	if (locale === "wuu") return wuu_security_userheader1(inputs)
	if (locale === "mr") return mr_security_userheader1(inputs)
	if (locale === "nb") return nb_security_userheader1(inputs)
	if (locale === "fi") return fi_security_userheader1(inputs)
	if (locale === "da") return da_security_userheader1(inputs)
	if (locale === "et") return et_security_userheader1(inputs)
	if (locale === "lv") return lv_security_userheader1(inputs)
	if (locale === "lt") return lt_security_userheader1(inputs)
	if (locale === "pl") return pl_security_userheader1(inputs)
	if (locale === "de") return de_security_userheader1(inputs)
	if (locale === "nl") return nl_security_userheader1(inputs)
	if (locale === "fr") return fr_security_userheader1(inputs)
	if (locale === "it") return it_security_userheader1(inputs)
	if (locale === "hu") return hu_security_userheader1(inputs)
	if (locale === "cs") return cs_security_userheader1(inputs)
	if (locale === "ro") return ro_security_userheader1(inputs)
	if (locale === "el") return el_security_userheader1(inputs)
	if (locale === "bg") return bg_security_userheader1(inputs)
	if (locale === "hr") return hr_security_userheader1(inputs)
	if (locale === "sr") return sr_security_userheader1(inputs)
	if (locale === "sk") return sk_security_userheader1(inputs)
	if (locale === "sl") return sl_security_userheader1(inputs)
	if (locale === "ko") return ko_security_userheader1(inputs)
	return en_security_userheader1(inputs)
});
export { security_userheader1 as "security_userHeader" }