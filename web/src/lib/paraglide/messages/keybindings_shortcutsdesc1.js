...
/** @typedef {{}} Keybindings_Shortcutsdesc1Inputs */

const en_keybindings_shortcutsdesc1 = /** @type {(inputs: Keybindings_Shortcutsdesc1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Show keyboard shortcuts help`)
};
...
*
* @param {Keybindings_Shortcutsdesc1Inputs} inputs
...
*/
const keybindings_shortcutsdesc1 = /** @type {((inputs?: Keybindings_Shortcutsdesc1Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Keybindings_Shortcutsdesc1Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_keybindings_shortcutsdesc1(inputs)
	if (locale === "sv") return sv_keybindings_shortcutsdesc1(inputs)
	if (locale === "uk") return uk_keybindings_shortcutsdesc1(inputs)
	if (locale === "zh") return zh_keybindings_shortcutsdesc1(inputs)
	if (locale === "es") return es_keybindings_shortcutsdesc1(inputs)
	if (locale === "hi") return hi_keybindings_shortcutsdesc1(inputs)
	if (locale === "pt") return pt_keybindings_shortcutsdesc1(inputs)
	if (locale === "bn") return bn_keybindings_shortcutsdesc1(inputs)
	if (locale === "ru") return ru_keybindings_shortcutsdesc1(inputs)
	if (locale === "ja") return ja_keybindings_shortcutsdesc1(inputs)
	if (locale === "vi") return vi_keybindings_shortcutsdesc1(inputs)
	if (locale === "yue") return yue_keybindings_shortcutsdesc1(inputs)
	if (locale === "tr") return tr_keybindings_shortcutsdesc1(inputs)
	if (locale === "ar") return ar_keybindings_shortcutsdesc1(inputs)
	if (locale === "wuu") return wuu_keybindings_shortcutsdesc1(inputs)
	if (locale === "mr") return mr_keybindings_shortcutsdesc1(inputs)
	if (locale === "nb") return nb_keybindings_shortcutsdesc1(inputs)
	if (locale === "fi") return fi_keybindings_shortcutsdesc1(inputs)
	if (locale === "da") return da_keybindings_shortcutsdesc1(inputs)
	if (locale === "et") return et_keybindings_shortcutsdesc1(inputs)
	if (locale === "lv") return lv_keybindings_shortcutsdesc1(inputs)
	if (locale === "lt") return lt_keybindings_shortcutsdesc1(inputs)
	if (locale === "pl") return pl_keybindings_shortcutsdesc1(inputs)
	if (locale === "de") return de_keybindings_shortcutsdesc1(inputs)
	if (locale === "nl") return nl_keybindings_shortcutsdesc1(inputs)
	if (locale === "fr") return fr_keybindings_shortcutsdesc1(inputs)
	if (locale === "it") return it_keybindings_shortcutsdesc1(inputs)
	if (locale === "hu") return hu_keybindings_shortcutsdesc1(inputs)
	if (locale === "cs") return cs_keybindings_shortcutsdesc1(inputs)
	if (locale === "ro") return ro_keybindings_shortcutsdesc1(inputs)
	if (locale === "el") return el_keybindings_shortcutsdesc1(inputs)
	if (locale === "bg") return bg_keybindings_shortcutsdesc1(inputs)
	if (locale === "hr") return hr_keybindings_shortcutsdesc1(inputs)
	if (locale === "sr") return sr_keybindings_shortcutsdesc1(inputs)
	if (locale === "sk") return sk_keybindings_shortcutsdesc1(inputs)
	if (locale === "sl") return sl_keybindings_shortcutsdesc1(inputs)
	return ko_keybindings_shortcutsdesc1(inputs)
});
export { keybindings_shortcutsdesc1 as "keybindings_shortcutsDesc" }