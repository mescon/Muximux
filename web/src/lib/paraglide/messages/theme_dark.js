...
const ko_theme_dark = /** @type {(inputs: Theme_DarkInputs) => LocalizedString} */ () => {
...
export const theme_dark = /** @type {((inputs?: Theme_DarkInputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Theme_DarkInputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "es") return es_theme_dark(inputs)
	if (locale === "hi") return hi_theme_dark(inputs)
	if (locale === "pt") return pt_theme_dark(inputs)
	...
	if (locale === "ar") return ar_theme_dark(inputs)
	if (locale === "wuu") return wuu_theme_dark(inputs)
	if (locale === "mr") return mr_theme_dark(inputs)
	if (locale === "nb") return nb_theme_dark(inputs)
	if (locale === "fi") return fi_theme_dark(inputs)
	if (locale === "da") return da_theme_dark(inputs)
	if (locale === "et") return et_theme_dark(inputs)
	if (locale === "lv") return lv_theme_dark(inputs)
	if (locale === "lt") return lt_theme_dark(inputs)
	if (locale === "pl") return pl_theme_dark(inputs)
	if (locale === "de") return de_theme_dark(inputs)
	if (locale === "nl") return nl_theme_dark(inputs)
	if (locale === "fr") return fr_theme_dark(inputs)
	if (locale === "it") return it_theme_dark(inputs)
	if (locale === "hu") return hu_theme_dark(inputs)
	if (locale === "cs") return cs_theme_dark(inputs)
	if (locale === "ro") return ro_theme_dark(inputs)
	if (locale === "el") return el_theme_dark(inputs)
	if (locale === "bg") return bg_theme_dark(inputs)
	if (locale === "hr") return hr_theme_dark(inputs)
