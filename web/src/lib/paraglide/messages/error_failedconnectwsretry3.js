...
/** @typedef {{}} Error_Failedconnectwsretry3Inputs */

const en_error_failedconnectwsretry3 = /** @type {(inputs: Error_Failedconnectwsretry3Inputs) => LocalizedString} */ () => {
...
const ko_error_failedconnectwsretry3 = /** @type {(inputs: Error_Failedconnectwsretry3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`여러 번 시도했지만 연결에 실패했습니다`)
};
...
const error_failedconnectwsretry3 = /** @type {((inputs?: Error_Failedconnectwsretry3Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Error_Failedconnectwsretry3Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_error_failedconnectwsretry3(inputs)
	if (locale === "zh") return zh_error_failedconnectwsretry3(inputs)
	if (locale === "es") return es_error_failedconnectwsretry3(inputs)
	if (locale === "hi") return hi_error_failedconnectwsretry3(inputs)
	if (locale === "pt") return pt_error_failedconnectwsretry3(inputs)
	...
	if (locale === "ar") return ar_error_failedconnectwsretry3(inputs)
	if (locale === "wuu") return wuu_error_failedconnectwsretry3(inputs)
	if (locale === "mr") return mr_error_failedconnectwsretry3(inputs)
	if (locale === "nb") return nb_error_failedconnectwsretry3(inputs)
	if (locale === "fi") return fi_error_failedconnectwsretry3(inputs)
	if (locale === "da") return da_error_failedconnectwsretry3(inputs)
	if (locale === "et") return et_error_failedconnectwsretry3(inputs)
	if (locale === "lv") return lv_error_failedconnectwsretry3(inputs)
	if (locale === "lt") return lt_error_failedconnectwsretry3(inputs)
	if (locale === "pl") return pl_error_failedconnectwsretry3(inputs)
	if (locale === "de") return de_error_failedconnectwsretry3(inputs)
	if (locale === "nl") return nl_error_failedconnectwsretry3(inputs)
	if (locale === "fr") return fr_error_failedconnectwsretry3(inputs)
	if (locale === "it") return it_error_failedconnectwsretry3(inputs)
	if (locale === "hu") return hu_error_failedconnectwsretry3(inputs)
	if (locale === "cs") return cs_error_failedconnectwsretry3(inputs)
	if (locale === "ro") return ro_error_failedconnectwsretry3(inputs)
	if (locale === "el") return el_error_failedconnectwsretry3(inputs)
	if (locale === "bg") return bg_error_failedconnectwsretry3(inputs)
	if (locale === "hr") return hr_error_failedconnectwsretry3(inputs)
	if (locale === "sr") return sr_error_failedconnectwsretry3(inputs)
	if (locale === "sk") return sk_error_failedconnectwsretry3(inputs)
	if (locale === "sl") return sl_error_failedconnectwsretry3(inputs)
	if (locale === "ko") return ko_error_failedconnectwsretry3(inputs)
	return en_error_failedconnectwsretry3(inputs)
});
export { error_failedconnectwsretry3 as "error_failedConnectWsRetry" }