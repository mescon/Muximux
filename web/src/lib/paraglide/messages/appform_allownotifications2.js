...
/** @typedef {{}} Appform_Allownotifications2Inputs */

const en_appform_allownotifications2 = /** @type {(inputs: Appform_Allownotifications2Inputs) => LocalizedString} */ () => {
...
const ko_appform_allownotifications2 = /** @type {(inputs: Appform_Allownotifications2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`알림 허용`)
};
...
* | "Allow notifications" |
*
* @param {Appform_Allownotifications2Inputs} inputs
...
*/
const appform_allownotifications2 = /** @type {((inputs?: Appform_Allownotifications2Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Appform_Allownotifications2Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_appform_allownotifications2(inputs)
	if (locale === "sv") return sv_appform_allownotifications2(inputs)
	if (locale === "uk") return uk_appform_allownotifications2(inputs)
	if (locale === "zh") return zh_appform_allownotifications2(inputs)
	if (locale === "es") return es_appform_allownotifications2(inputs)
	if (locale === "hi") return hi_appform_allownotifications2(inputs)
	if (locale === "pt") return pt_appform_allownotifications2(inputs)
	if (locale === "bn") return bn_appform_allownotifications2(inputs)
	if (locale === "ru") return ru_appform_allownotifications2(inputs)
	if (locale === "ja") return ja_appform_allownotifications2(inputs)
	if (locale === "vi") return vi_appform_allownotifications2(inputs)
	if (locale === "yue") return yue_appform_allownotifications2(inputs)
	if (locale === "tr") return tr_appform_allownotifications2(inputs)
	if (locale === "ar") return ar_appform_allownotifications2(inputs)
	if (locale === "wuu") return wuu_appform_allownotifications2(inputs)
	if (locale === "mr") return mr_appform_allownotifications2(inputs)
	if (locale === "nb") return nb_appform_allownotifications2(inputs)
	if (locale === "fi") return fi_appform_allownotifications2(inputs)
	if (locale === "da") return da_appform_allownotifications2(inputs)
	if (locale === "et") return et_appform_allownotifications2(inputs)
	if (locale === "lv") return lv_appform_allownotifications2(inputs)
	if (locale === "lt") return lt_appform_allownotifications2(inputs)
	if (locale === "pl") return pl_appform_allownotifications2(inputs)
	if (locale === "de") return de_appform_allownotifications2(inputs)
	if (locale === "nl") return nl_appform_allownotifications2(inputs)
	if (locale === "fr") return fr_appform_allownotifications2(inputs)
	if (locale === "it") return it_appform_allownotifications2(inputs)
	if (locale === "hu") return hu_appform_allownotifications2(inputs)
	if (locale === "cs") return cs_appform_allownotifications2(inputs)
	if (locale === "ro") return ro_appform_allownotifications2(inputs)
	if (locale === "el") return el_appform_allownotifications2(inputs)
	if (locale === "bg") return bg_appform_allownotifications2(inputs)
	if (locale === "hr") return hr_appform_allownotifications2(inputs)
	if (locale === "sr") return sr_appform_allownotifications2(inputs)
	if (locale === "sk") return sk_appform_allownotifications2(inputs)
	if (locale === "sl") return sl_appform_allownotifications2(inputs)
	return ko_appform_allownotifications2(inputs)
});
export { appform_allownotifications2 as "appForm_allowNotifications" }