...
/** @typedef {{}} Splash_Selectapp1Inputs */

const en_splash_selectapp1 = /** @type {(inputs: Splash_Selectapp1Inputs) => LocalizedString} */ () => {
...
const ru_splash_selectapp1 = /** @type {(inputs: Splash_Selectapp1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Выберите приложение для начала работы`)
};
...
const ko_splash_selectapp1 = /** @type {(inputs: Splash_Selectapp1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`시작할 애플리케이션을 선택하세요`)
};
...
const splash_selectapp1 = /** @type {((inputs?: Splash_Selectapp1Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Splash_Selectapp1Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_splash_selectapp1(inputs)
	if (locale === "zh") return zh_splash_selectapp1(inputs)
	if (locale === "es") return es_splash_selectapp1(inputs)
	if (locale === "hi") return hi_splash_selectapp1(inputs)
	if (locale === "pt") return pt_splash_selectapp1(inputs)
	...
	if (locale === "ar") return ar_splash_selectapp1(inputs)
	if (locale === "wuu") return wuu_splash_selectapp1(inputs)
	if (locale === "mr") return mr_splash_selectapp1(inputs)
	if (locale === "nb") return nb_splash_selectapp1(inputs)
	if (locale === "fi") return fi_splash_selectapp1(inputs)
	if (locale === "da") return da_splash_selectapp1(inputs)
	if (locale === "et") return et_splash_selectapp1(inputs)
	if (locale === "lv") return lv_splash_selectapp1(inputs)
	if (locale === "lt") return lt_splash_selectapp1(inputs)
	if (locale === "pl") return pl_splash_selectapp1(inputs)
	if (locale === "de") return de_splash_selectapp1(inputs)
	if (locale === "nl") return nl_splash_selectapp1(inputs)
	if (locale === "fr") return fr_splash_selectapp1(inputs)
	if (locale === "it") return it_splash_selectapp1(inputs)
	if (locale === "hu") return hu_splash_selectapp1(inputs)
	if (locale === "cs") return cs_splash_selectapp1(inputs)
	if (locale === "ro") return ro_splash_selectapp1(inputs)
	if (locale === "el") return el_splash_selectapp1(inputs)
	if (locale === "bg") return bg_splash_selectapp1(inputs)
	if (locale === "hr") return hr_splash_selectapp1(inputs)
	if (locale === "sr") return sr_splash_selectapp1(inputs)
	if (locale === "sk") return sk_splash_selectapp1(inputs)
	if (locale === "sl") return sl_splash_selectapp1(inputs)
	if (locale === "ko") return ko_splash_selectapp1(inputs)
	return en_splash_selectapp1(inputs)
});
export { splash_selectapp1 as "splash_selectApp" }