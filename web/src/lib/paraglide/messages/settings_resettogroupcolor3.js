...
/** @typedef {{}} Settings_Resettogroupcolor3Inputs */

const en_settings_resettogroupcolor3 = /** @type {(inputs: Settings_Resettogroupcolor3Inputs) => LocalizedString} */ () => {
...
const ko_settings_resettogroupcolor3 = /** @type {(inputs: Settings_Resettogroupcolor3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`그룹 색상으로 재설정`)
};
...
const settings_resettogroupcolor3 = /** @type {((inputs?: Settings_Resettogroupcolor3Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Settings_Resettogroupcolor3Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_settings_resettogroupcolor3(inputs)
	if (locale === "zh") return zh_settings_resettogroupcolor3(inputs)
	if (locale === "es") return es_settings_resettogroupcolor3(inputs)
	if (locale === "hi") return hi_settings_resettogroupcolor3(inputs)
	if (locale === "pt") return pt_settings_resettogroupcolor3(inputs)
	...
	if (locale === "ar") return ar_settings_resettogroupcolor3(inputs)
	if (locale === "wuu") return wuu_settings_resettogroupcolor3(inputs)
	if (locale === "mr") return mr_settings_resettogroupcolor3(inputs)
	if (locale === "nb") return nb_settings_resettogroupcolor3(inputs)
	if (locale === "fi") return fi_settings_resettogroupcolor3(inputs)
	if (locale === "da") return da_settings_resettogroupcolor3(inputs)
	if (locale === "et") return et_settings_resettogroupcolor3(inputs)
	if (locale === "lv") return lv_settings_resettogroupcolor3(inputs)
	if (locale === "lt") return lt_settings_resettogroupcolor3(inputs)
	if (locale === "pl") return pl_settings_resettogroupcolor3(inputs)
	if (locale === "de") return de_settings_resettogroupcolor3(inputs)
	if (locale === "nl") return nl_settings_resettogroupcolor3(inputs)
	if (locale === "fr") return fr_settings_resettogroupcolor3(inputs)
	if (locale === "it") return it_settings_resettogroupcolor3(inputs)
	if (locale === "hu") return hu_settings_resettogroupcolor3(inputs)
	if (locale === "cs") return cs_settings_resettogroupcolor3(inputs)
	if (locale === "ro") return ro_settings_resettogroupcolor3(inputs)
	if (locale === "el") return el_settings_resettogroupcolor3(inputs)
	if (locale === "bg") return bg_settings_resettogroupcolor3(inputs)
	if (locale === "hr") return hr_settings_resettogroupcolor3(inputs)
	if (locale === "sr") return sr_settings_resettogroupcolor3(inputs)
	if (locale === "sk") return sk_settings_resettogroupcolor3(inputs)
	if (locale === "sl") return sl_settings_resettogroupcolor3(inputs)
	if (locale === "ko") return ko_settings_resettogroupcolor3(inputs)
	return en_settings_resettogroupcolor3(inputs)
});
export { settings_resettogroupcolor3 as "settings_resetToGroupColor" }