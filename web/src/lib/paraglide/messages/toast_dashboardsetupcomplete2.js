...
/** @typedef {{}} Toast_Dashboardsetupcomplete2Inputs */

const en_toast_dashboardsetupcomplete2 = /** @type {(inputs: Toast_Dashboardsetupcomplete2Inputs) => LocalizedString} */ () => {
...
const ru_toast_dashboardsetupcomplete2 = /** @type {(inputs: Toast_Dashboardsetupcomplete2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Настройка панели управления завершена!`)
};
...
const ko_toast_dashboardsetupcomplete2 = /** @type {(inputs: Toast_Dashboardsetupcomplete2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`대시보드 설정이 완료되었습니다!`)
};
...
const toast_dashboardsetupcomplete2 = /** @type {((inputs?: Toast_Dashboardsetupcomplete2Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Toast_Dashboardsetupcomplete2Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "es") return es_toast_dashboardsetupcomplete2(inputs)
	if (locale === "hi") return hi_toast_dashboardsetupcomplete2(inputs)
	if (locale === "pt") return pt_toast_dashboardsetupcomplete2(inputs)
	...
	if (locale === "ar") return ar_toast_dashboardsetupcomplete2(inputs)
	if (locale === "wuu") return wuu_toast_dashboardsetupcomplete2(inputs)
	if (locale === "mr") return mr_toast_dashboardsetupcomplete2(inputs)
	if (locale === "nb") return nb_toast_dashboardsetupcomplete2(inputs)
	if (locale === "fi") return fi_toast_dashboardsetupcomplete2(inputs)
	if (locale === "da") return da_toast_dashboardsetupcomplete2(inputs)
	if (locale === "et") return et_toast_dashboardsetupcomplete2(inputs)
	if (locale === "lv") return lv_toast_dashboardsetupcomplete2(inputs)
	if (locale === "lt") return lt_toast_dashboardsetupcomplete2(inputs)
	if (locale === "pl") return pl_toast_dashboardsetupcomplete2(inputs)
	if (locale === "de") return de_toast_dashboardsetupcomplete2(inputs)
	if (locale === "nl") return nl_toast_dashboardsetupcomplete2(inputs)
	if (locale === "fr") return fr_toast_dashboardsetupcomplete2(inputs)
	if (locale === "it") return it_toast_dashboardsetupcomplete2(inputs)
	if (locale === "hu") return hu_toast_dashboardsetupcomplete2(inputs)
	if (locale === "cs") return cs_toast_dashboardsetupcomplete2(inputs)
	if (locale === "ro") return ro_toast_dashboardsetupcomplete2(inputs)
	if (locale === "el") return el_toast_dashboardsetupcomplete2(inputs)
	if (locale === "bg") return bg_toast_dashboardsetupcomplete2(inputs)
	if (locale === "hr") return hr_toast_dashboardsetupcomplete2(inputs)
