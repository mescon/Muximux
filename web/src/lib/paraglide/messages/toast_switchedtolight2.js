...
/** @typedef {{}} Toast_Switchedtolight2Inputs */

const en_toast_switchedtolight2 = /** @type {(inputs: Toast_Switchedtolight2Inputs) => LocalizedString} */ () => {
...
const ko_toast_switchedtolight2 = /** @type {(inputs: Toast_Switchedtolight2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`라이트 테마로 전환되었습니다`)
};
...
const toast_switchedtolight2 = /** @type {((inputs?: Toast_Switchedtolight2Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Toast_Switchedtolight2Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "es") return es_toast_switchedtolight2(inputs)
	if (locale === "hi") return hi_toast_switchedtolight2(inputs)
	if (locale === "pt") return pt_toast_switchedtolight2(inputs)
	...
	if (locale === "ar") return ar_toast_switchedtolight2(inputs)
	if (locale === "wuu") return wuu_toast_switchedtolight2(inputs)
	if (locale === "mr") return mr_toast_switchedtolight2(inputs)
	if (locale === "nb") return nb_toast_switchedtolight2(inputs)
	if (locale === "fi") return fi_toast_switchedtolight2(inputs)
	if (locale === "da") return da_toast_switchedtolight2(inputs)
	if (locale === "et") return et_toast_switchedtolight2(inputs)
	if (locale === "lv") return lv_toast_switchedtolight2(inputs)
	if (locale === "lt") return lt_toast_switchedtolight2(inputs)
	if (locale === "pl") return pl_toast_switchedtolight2(inputs)
	if (locale === "de") return de_toast_switchedtolight2(inputs)
	if (locale === "nl") return nl_toast_switchedtolight2(inputs)
	if (locale === "fr") return fr_toast_switchedtolight2(inputs)
	if (locale === "it") return it_toast_switchedtolight2(inputs)
	if (locale === "hu") return hu_toast_switchedtolight2(inputs)
	if (locale === "cs") return cs_toast_switchedtolight2(inputs)
	if (locale === "ro") return ro_toast_switchedtolight2(inputs)
	if (locale === "el") return el_toast_switchedtolight2(inputs)
	if (locale === "bg") return bg_toast_switchedtolight2(inputs)
	if (locale === "hr") return hr_toast_switchedtolight2(inputs)
