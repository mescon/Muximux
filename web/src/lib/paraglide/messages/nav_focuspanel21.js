...
/** @typedef {{}} Nav_Focuspanel21Inputs */

const en_nav_focuspanel21 = /** @type {(inputs: Nav_Focuspanel21Inputs) => LocalizedString} */ () => {
...
const ko_nav_focuspanel21 = /** @type {(inputs: Nav_Focuspanel21Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`패널 2에 포커스`)
};
...
const nav_focuspanel21 = /** @type {((inputs?: Nav_Focuspanel21Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Nav_Focuspanel21Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_nav_focuspanel21(inputs)
	if (locale === "zh") return zh_nav_focuspanel21(inputs)
	if (locale === "es") return es_nav_focuspanel21(inputs)
	if (locale === "hi") return hi_nav_focuspanel21(inputs)
	if (locale === "pt") return pt_nav_focuspanel21(inputs)
	...
	if (locale === "ar") return ar_nav_focuspanel21(inputs)
	if (locale === "wuu") return wuu_nav_focuspanel21(inputs)
	if (locale === "mr") return mr_nav_focuspanel21(inputs)
	if (locale === "nb") return nb_nav_focuspanel21(inputs)
	if (locale === "fi") return fi_nav_focuspanel21(inputs)
	if (locale === "da") return da_nav_focuspanel21(inputs)
	if (locale === "et") return et_nav_focuspanel21(inputs)
	if (locale === "lv") return lv_nav_focuspanel21(inputs)
	if (locale === "lt") return lt_nav_focuspanel21(inputs)
	if (locale === "pl") return pl_nav_focuspanel21(inputs)
	if (locale === "de") return de_nav_focuspanel21(inputs)
	if (locale === "nl") return nl_nav_focuspanel21(inputs)
	if (locale === "fr") return fr_nav_focuspanel21(inputs)
	if (locale === "it") return it_nav_focuspanel21(inputs)
	if (locale === "hu") return hu_nav_focuspanel21(inputs)
	if (locale === "cs") return cs_nav_focuspanel21(inputs)
	if (locale === "ro") return ro_nav_focuspanel21(inputs)
	if (locale === "el") return el_nav_focuspanel21(inputs)
	if (locale === "bg") return bg_nav_focuspanel21(inputs)
	if (locale === "hr") return hr_nav_focuspanel21(inputs)
	if (locale === "sr") return sr_nav_focuspanel21(inputs)
	if (locale === "sk") return sk_nav_focuspanel21(inputs)
	if (locale === "sl") return sl_nav_focuspanel21(inputs)
	if (locale === "ko") return ko_nav_focuspanel21(inputs)
	return en_nav_focuspanel21(inputs)
});
export { nav_focuspanel21 as "nav_focusPanel2" }