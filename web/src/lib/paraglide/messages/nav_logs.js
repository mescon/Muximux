...
const nl_nav_logs = /** @type {(inputs: Nav_LogsInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Logs`)
};

const fr_nav_logs = /** @type {(inputs: Nav_LogsInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Logs`)
};
...
const ko_nav_logs = /** @type {(inputs: Nav_LogsInputs) => LocalizedString} */ () => {
...
export const nav_logs = /** @type {((inputs?: Nav_LogsInputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Nav_LogsInputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_nav_logs(inputs)
	if (locale === "zh") return zh_nav_logs(inputs)
	if (locale === "es") return es_nav_logs(inputs)
	if (locale === "hi") return hi_nav_logs(inputs)
	if (locale === "pt") return pt_nav_logs(inputs)
	...
	if (locale === "ar") return ar_nav_logs(inputs)
	if (locale === "wuu") return wuu_nav_logs(inputs)
	if (locale === "mr") return mr_nav_logs(inputs)
	if (locale === "nb") return nb_nav_logs(inputs)
	if (locale === "fi") return fi_nav_logs(inputs)
	if (locale === "da") return da_nav_logs(inputs)
	if (locale === "et") return et_nav_logs(inputs)
	if (locale === "lv") return lv_nav_logs(inputs)
	if (locale === "lt") return lt_nav_logs(inputs)
	if (locale === "pl") return pl_nav_logs(inputs)
	if (locale === "de") return de_nav_logs(inputs)
	if (locale === "nl") return nl_nav_logs(inputs)
	if (locale === "fr") return fr_nav_logs(inputs)
	if (locale === "it") return it_nav_logs(inputs)
	if (locale === "hu") return hu_nav_logs(inputs)
	if (locale === "cs") return cs_nav_logs(inputs)
	if (locale === "ro") return ro_nav_logs(inputs)
	if (locale === "el") return el_nav_logs(inputs)
	if (locale === "bg") return bg_nav_logs(inputs)
	if (locale === "hr") return hr_nav_logs(inputs)
	if (locale === "sr") return sr_nav_logs(inputs)
	if (locale === "sk") return sk_nav_logs(inputs)
	if (locale === "sl") return sl_nav_logs(inputs)
	if (locale === "ko") return ko_nav_logs(inputs)
