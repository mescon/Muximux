...
/** @typedef {{}} Apps_ScaleInputs */

const en_apps_scale = /** @type {(inputs: Apps_ScaleInputs) => LocalizedString} */ () => {
...
const ko_apps_scale = /** @type {(inputs: Apps_ScaleInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`배율`)
};
...
export const apps_scale = /** @type {((inputs?: Apps_ScaleInputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Apps_ScaleInputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "es") return es_apps_scale(inputs)
	if (locale === "hi") return hi_apps_scale(inputs)
	if (locale === "pt") return pt_apps_scale(inputs)
	...
	if (locale === "ar") return ar_apps_scale(inputs)
	if (locale === "wuu") return wuu_apps_scale(inputs)
	if (locale === "mr") return mr_apps_scale(inputs)
	if (locale === "nb") return nb_apps_scale(inputs)
	if (locale === "fi") return fi_apps_scale(inputs)
	if (locale === "da") return da_apps_scale(inputs)
	if (locale === "et") return et_apps_scale(inputs)
	if (locale === "lv") return lv_apps_scale(inputs)
	if (locale === "lt") return lt_apps_scale(inputs)
	if (locale === "pl") return pl_apps_scale(inputs)
	if (locale === "de") return de_apps_scale(inputs)
	if (locale === "nl") return nl_apps_scale(inputs)
	if (locale === "fr") return fr_apps_scale(inputs)
	if (locale === "it") return it_apps_scale(inputs)
	if (locale === "hu") return hu_apps_scale(inputs)
	if (locale === "cs") return cs_apps_scale(inputs)
	if (locale === "ro") return ro_apps_scale(inputs)
	if (locale === "el") return el_apps_scale(inputs)
	if (locale === "bg") return bg_apps_scale(inputs)
	if (locale === "hr") return hr_apps_scale(inputs)
