...
/** @typedef {{}} Common_RoleInputs */

const en_common_role = /** @type {(inputs: Common_RoleInputs) => LocalizedString} */ () => {
...
const ko_common_role = /** @type {(inputs: Common_RoleInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`역할`)
};
...
export const common_role = /** @type {((inputs?: Common_RoleInputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Common_RoleInputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_common_role(inputs)
	if (locale === "zh") return zh_common_role(inputs)
	if (locale === "es") return es_common_role(inputs)
	if (locale === "hi") return hi_common_role(inputs)
	if (locale === "pt") return pt_common_role(inputs)
	...
	if (locale === "ar") return ar_common_role(inputs)
	if (locale === "wuu") return wuu_common_role(inputs)
	if (locale === "mr") return mr_common_role(inputs)
	if (locale === "nb") return nb_common_role(inputs)
	if (locale === "fi") return fi_common_role(inputs)
	if (locale === "da") return da_common_role(inputs)
	if (locale === "et") return et_common_role(inputs)
	if (locale === "lv") return lv_common_role(inputs)
	if (locale === "lt") return lt_common_role(inputs)
	if (locale === "pl") return pl_common_role(inputs)
	if (locale === "de") return de_common_role(inputs)
	if (locale === "nl") return nl_common_role(inputs)
	if (locale === "fr") return fr_common_role(inputs)
	if (locale === "it") return it_common_role(inputs)
	if (locale === "hu") return hu_common_role(inputs)
	if (locale === "cs") return cs_common_role(inputs)
	if (locale === "ro") return ro_common_role(inputs)
	if (locale === "el") return el_common_role(inputs)
	if (locale === "bg") return bg_common_role(inputs)
	if (locale === "hr") return hr_common_role(inputs)
	if (locale === "sr") return sr_common_role(inputs)
	if (locale === "sk") return sk_common_role(inputs)
	if (locale === "sl") return sl_common_role(inputs)
	if (locale === "ko") return ko_common_role(inputs)
