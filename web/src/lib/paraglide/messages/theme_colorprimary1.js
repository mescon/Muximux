...
/** @typedef {{}} Theme_Colorprimary1Inputs */

const en_theme_colorprimary1 = /** @type {(inputs: Theme_Colorprimary1Inputs) => LocalizedString} */ () => {
...
const ru_theme_colorprimary1 = /** @type {(inputs: Theme_Colorprimary1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Основной цвет`)
};
...
const ko_theme_colorprimary1 = /** @type {(inputs: Theme_Colorprimary1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`주 색상`)
};
...
const theme_colorprimary1 = /** @type {((inputs?: Theme_Colorprimary1Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Theme_Colorprimary1Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_theme_colorprimary1(inputs)
	if (locale === "zh") return zh_theme_colorprimary1(inputs)
	if (locale === "es") return es_theme_colorprimary1(inputs)
	if (locale === "hi") return hi_theme_colorprimary1(inputs)
	if (locale === "pt") return pt_theme_colorprimary1(inputs)
	...
	if (locale === "ar") return ar_theme_colorprimary1(inputs)
	if (locale === "wuu") return wuu_theme_colorprimary1(inputs)
	if (locale === "mr") return mr_theme_colorprimary1(inputs)
	if (locale === "nb") return nb_theme_colorprimary1(inputs)
	if (locale === "fi") return fi_theme_colorprimary1(inputs)
	if (locale === "da") return da_theme_colorprimary1(inputs)
	if (locale === "et") return et_theme_colorprimary1(inputs)
	if (locale === "lv") return lv_theme_colorprimary1(inputs)
	if (locale === "lt") return lt_theme_colorprimary1(inputs)
	if (locale === "pl") return pl_theme_colorprimary1(inputs)
	if (locale === "de") return de_theme_colorprimary1(inputs)
	if (locale === "nl") return nl_theme_colorprimary1(inputs)
	if (locale === "fr") return fr_theme_colorprimary1(inputs)
	if (locale === "it") return it_theme_colorprimary1(inputs)
	if (locale === "hu") return hu_theme_colorprimary1(inputs)
	if (locale === "cs") return cs_theme_colorprimary1(inputs)
	if (locale === "ro") return ro_theme_colorprimary1(inputs)
	if (locale === "el") return el_theme_colorprimary1(inputs)
	if (locale === "bg") return bg_theme_colorprimary1(inputs)
	if (locale === "hr") return hr_theme_colorprimary1(inputs)
	if (locale === "sr") return sr_theme_colorprimary1(inputs)
	if (locale === "sk") return sk_theme_colorprimary1(inputs)
	if (locale === "sl") return sl_theme_colorprimary1(inputs)
	if (locale === "ko") return ko_theme_colorprimary1(inputs)
	return en_theme_colorprimary1(inputs)
});
export { theme_colorprimary1 as "theme_colorPrimary" }