...
const ko_settings_discard = /** @type {(inputs: Settings_DiscardInputs) => LocalizedString} */ () => {
...
export const settings_discard = /** @type {((inputs?: Settings_DiscardInputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Settings_DiscardInputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_settings_discard(inputs)
	if (locale === "zh") return zh_settings_discard(inputs)
	if (locale === "es") return es_settings_discard(inputs)
	if (locale === "hi") return hi_settings_discard(inputs)
	...
	if (locale === "ar") return ar_settings_discard(inputs)
	if (locale === "wuu") return wuu_settings_discard(inputs)
	if (locale === "mr") return mr_settings_discard(inputs)
	if (locale === "nb") return nb_settings_discard(inputs)
	if (locale === "fi") return fi_settings_discard(inputs)
	if (locale === "da") return da_settings_discard(inputs)
	if (locale === "et") return et_settings_discard(inputs)
	if (locale === "lv") return lv_settings_discard(inputs)
	if (locale === "lt") return lt_settings_discard(inputs)
	...
	if (locale === "hu") return hu_settings_discard(inputs)
	if (locale === "cs") return cs_settings_discard(inputs)
	if (locale === "ro") return ro_settings_discard(inputs)
	if (locale === "el") return el_settings_discard(inputs)
	if (locale === "bg") return bg_settings_discard(inputs)
	if (locale === "hr") return hr_settings_discard(inputs)
	if (locale === "sr") return sr_settings_discard(inputs)
	if (locale === "sk") return sk_settings_discard(inputs)
	if (locale === "sl") return sl_settings_discard(inputs)
	if (locale === "ko") return ko_settings_discard(inputs)
