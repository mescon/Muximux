...
/** @typedef {{}} Login_Passwordplaceholder1Inputs */

const en_login_passwordplaceholder1 = /** @type {(inputs: Login_Passwordplaceholder1Inputs) => LocalizedString} */ () => {
...
const ko_login_passwordplaceholder1 = /** @type {(inputs: Login_Passwordplaceholder1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`비밀번호를 입력하세요`)
};
...
const login_passwordplaceholder1 = /** @type {((inputs?: Login_Passwordplaceholder1Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Login_Passwordplaceholder1Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_login_passwordplaceholder1(inputs)
	if (locale === "zh") return zh_login_passwordplaceholder1(inputs)
	if (locale === "es") return es_login_passwordplaceholder1(inputs)
	if (locale === "hi") return hi_login_passwordplaceholder1(inputs)
	if (locale === "pt") return pt_login_passwordplaceholder1(inputs)
	...
	if (locale === "ar") return ar_login_passwordplaceholder1(inputs)
	if (locale === "wuu") return wuu_login_passwordplaceholder1(inputs)
	if (locale === "mr") return mr_login_passwordplaceholder1(inputs)
	if (locale === "nb") return nb_login_passwordplaceholder1(inputs)
	if (locale === "fi") return fi_login_passwordplaceholder1(inputs)
	if (locale === "da") return da_login_passwordplaceholder1(inputs)
	if (locale === "et") return et_login_passwordplaceholder1(inputs)
	if (locale === "lv") return lv_login_passwordplaceholder1(inputs)
	if (locale === "lt") return lt_login_passwordplaceholder1(inputs)
	if (locale === "pl") return pl_login_passwordplaceholder1(inputs)
	if (locale === "de") return de_login_passwordplaceholder1(inputs)
	if (locale === "nl") return nl_login_passwordplaceholder1(inputs)
	if (locale === "fr") return fr_login_passwordplaceholder1(inputs)
	if (locale === "it") return it_login_passwordplaceholder1(inputs)
	if (locale === "hu") return hu_login_passwordplaceholder1(inputs)
	if (locale === "cs") return cs_login_passwordplaceholder1(inputs)
	if (locale === "ro") return ro_login_passwordplaceholder1(inputs)
	if (locale === "el") return el_login_passwordplaceholder1(inputs)
	if (locale === "bg") return bg_login_passwordplaceholder1(inputs)
	if (locale === "hr") return hr_login_passwordplaceholder1(inputs)
	if (locale === "sr") return sr_login_passwordplaceholder1(inputs)
	if (locale === "sk") return sk_login_passwordplaceholder1(inputs)
	if (locale === "sl") return sl_login_passwordplaceholder1(inputs)
	if (locale === "ko") return ko_login_passwordplaceholder1(inputs)
	return en_login_passwordplaceholder1(inputs)
});
export { login_passwordplaceholder1 as "login_passwordPlaceholder" }