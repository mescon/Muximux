...
/** @typedef {{}} Appform_None1Inputs */

const en_appform_none1 = /** @type {(inputs: Appform_None1Inputs) => LocalizedString} */ () => {
...
const ko_appform_none1 = /** @type {(inputs: Appform_None1Inputs) => LocalizedString} */ () => {
...
const appform_none1 = /** @type {((inputs?: Appform_None1Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Appform_None1Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_appform_none1(inputs)
	if (locale === "zh") return zh_appform_none1(inputs)
	if (locale === "es") return es_appform_none1(inputs)
	if (locale === "hi") return hi_appform_none1(inputs)
	if (locale === "pt") return pt_appform_none1(inputs)
	...
	if (locale === "ar") return ar_appform_none1(inputs)
	if (locale === "wuu") return wuu_appform_none1(inputs)
	if (locale === "mr") return mr_appform_none1(inputs)
	if (locale === "nb") return nb_appform_none1(inputs)
	if (locale === "fi") return fi_appform_none1(inputs)
	if (locale === "da") return da_appform_none1(inputs)
	if (locale === "et") return et_appform_none1(inputs)
	if (locale === "lv") return lv_appform_none1(inputs)
	if (locale === "lt") return lt_appform_none1(inputs)
	if (locale === "pl") return pl_appform_none1(inputs)
	if (locale === "de") return de_appform_none1(inputs)
	if (locale === "nl") return nl_appform_none1(inputs)
	if (locale === "fr") return fr_appform_none1(inputs)
	if (locale === "it") return it_appform_none1(inputs)
	if (locale === "hu") return hu_appform_none1(inputs)
	if (locale === "cs") return cs_appform_none1(inputs)
	if (locale === "ro") return ro_appform_none1(inputs)
	if (locale === "el") return el_appform_none1(inputs)
	if (locale === "bg") return bg_appform_none1(inputs)
	if (locale === "hr") return hr_appform_none1(inputs)
	if (locale === "sr") return sr_appform_none1(inputs)
	if (locale === "sk") return sk_appform_none1(inputs)
	if (locale === "sl") return sl_appform_none1(inputs)
	if (locale === "ko") return ko_appform_none1(inputs)
	return en_appform_none1(inputs)
});
export { appform_none1 as "appForm_none" }