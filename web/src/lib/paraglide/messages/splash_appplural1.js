...
/** @typedef {{}} Splash_Appplural1Inputs */

const en_splash_appplural1 = /** @type {(inputs: Splash_Appplural1Inputs) => LocalizedString} */ () => {
...
const fr_splash_appplural1 = /** @type {(inputs: Splash_Appplural1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`apps`)
};
...
const ko_splash_appplural1 = /** @type {(inputs: Splash_Appplural1Inputs) => LocalizedString} */ () => {
...
const splash_appplural1 = /** @type {((inputs?: Splash_Appplural1Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Splash_Appplural1Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_splash_appplural1(inputs)
	if (locale === "zh") return zh_splash_appplural1(inputs)
	if (locale === "es") return es_splash_appplural1(inputs)
	if (locale === "hi") return hi_splash_appplural1(inputs)
	if (locale === "pt") return pt_splash_appplural1(inputs)
	...
	if (locale === "ar") return ar_splash_appplural1(inputs)
	if (locale === "wuu") return wuu_splash_appplural1(inputs)
	if (locale === "mr") return mr_splash_appplural1(inputs)
	if (locale === "nb") return nb_splash_appplural1(inputs)
	if (locale === "fi") return fi_splash_appplural1(inputs)
	if (locale === "da") return da_splash_appplural1(inputs)
	if (locale === "et") return et_splash_appplural1(inputs)
	if (locale === "lv") return lv_splash_appplural1(inputs)
	if (locale === "lt") return lt_splash_appplural1(inputs)
	if (locale === "pl") return pl_splash_appplural1(inputs)
	if (locale === "de") return de_splash_appplural1(inputs)
	if (locale === "nl") return nl_splash_appplural1(inputs)
	if (locale === "fr") return fr_splash_appplural1(inputs)
	if (locale === "it") return it_splash_appplural1(inputs)
	if (locale === "hu") return hu_splash_appplural1(inputs)
	if (locale === "cs") return cs_splash_appplural1(inputs)
	if (locale === "ro") return ro_splash_appplural1(inputs)
	if (locale === "el") return el_splash_appplural1(inputs)
	if (locale === "bg") return bg_splash_appplural1(inputs)
	if (locale === "hr") return hr_splash_appplural1(inputs)
	if (locale === "sr") return sr_splash_appplural1(inputs)
	if (locale === "sk") return sk_splash_appplural1(inputs)
	if (locale === "sl") return sl_splash_appplural1(inputs)
	if (locale === "ko") return ko_splash_appplural1(inputs)
	return en_splash_appplural1(inputs)
});
export { splash_appplural1 as "splash_appPlural" }