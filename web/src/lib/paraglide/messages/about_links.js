...
/** @typedef {{}} About_LinksInputs */

const en_about_links = /** @type {(inputs: About_LinksInputs) => LocalizedString} */ () => {
...
const nl_about_links = /** @type {(inputs: About_LinksInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Links`)
};
...
const ko_about_links = /** @type {(inputs: About_LinksInputs) => LocalizedString} */ () => {
...
export const about_links = /** @type {((inputs?: About_LinksInputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<About_LinksInputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "es") return es_about_links(inputs)
	if (locale === "hi") return hi_about_links(inputs)
	if (locale === "pt") return pt_about_links(inputs)
	...
	if (locale === "ar") return ar_about_links(inputs)
	if (locale === "wuu") return wuu_about_links(inputs)
	if (locale === "mr") return mr_about_links(inputs)
	if (locale === "nb") return nb_about_links(inputs)
	if (locale === "fi") return fi_about_links(inputs)
	if (locale === "da") return da_about_links(inputs)
	if (locale === "et") return et_about_links(inputs)
	if (locale === "lv") return lv_about_links(inputs)
	if (locale === "lt") return lt_about_links(inputs)
	if (locale === "pl") return pl_about_links(inputs)
	if (locale === "de") return de_about_links(inputs)
	if (locale === "nl") return nl_about_links(inputs)
	if (locale === "fr") return fr_about_links(inputs)
	if (locale === "it") return it_about_links(inputs)
	if (locale === "hu") return hu_about_links(inputs)
	if (locale === "cs") return cs_about_links(inputs)
	if (locale === "ro") return ro_about_links(inputs)
	if (locale === "el") return el_about_links(inputs)
	if (locale === "bg") return bg_about_links(inputs)
	if (locale === "hr") return hr_about_links(inputs)
