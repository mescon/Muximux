...
/** @typedef {{}} Command_Setlighttheme2Inputs */

const en_command_setlighttheme2 = /** @type {(inputs: Command_Setlighttheme2Inputs) => LocalizedString} */ () => {
...
const ko_command_setlighttheme2 = /** @type {(inputs: Command_Setlighttheme2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`라이트 테마 설정`)
};
...
const command_setlighttheme2 = /** @type {((inputs?: Command_Setlighttheme2Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Command_Setlighttheme2Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_command_setlighttheme2(inputs)
	if (locale === "zh") return zh_command_setlighttheme2(inputs)
	if (locale === "es") return es_command_setlighttheme2(inputs)
	if (locale === "hi") return hi_command_setlighttheme2(inputs)
	if (locale === "pt") return pt_command_setlighttheme2(inputs)
	...
	if (locale === "ar") return ar_command_setlighttheme2(inputs)
	if (locale === "wuu") return wuu_command_setlighttheme2(inputs)
	if (locale === "mr") return mr_command_setlighttheme2(inputs)
	if (locale === "nb") return nb_command_setlighttheme2(inputs)
	if (locale === "fi") return fi_command_setlighttheme2(inputs)
	if (locale === "da") return da_command_setlighttheme2(inputs)
	if (locale === "et") return et_command_setlighttheme2(inputs)
	if (locale === "lv") return lv_command_setlighttheme2(inputs)
	if (locale === "lt") return lt_command_setlighttheme2(inputs)
	if (locale === "pl") return pl_command_setlighttheme2(inputs)
	if (locale === "de") return de_command_setlighttheme2(inputs)
	if (locale === "nl") return nl_command_setlighttheme2(inputs)
	if (locale === "fr") return fr_command_setlighttheme2(inputs)
	if (locale === "it") return it_command_setlighttheme2(inputs)
	if (locale === "hu") return hu_command_setlighttheme2(inputs)
	if (locale === "cs") return cs_command_setlighttheme2(inputs)
	if (locale === "ro") return ro_command_setlighttheme2(inputs)
	if (locale === "el") return el_command_setlighttheme2(inputs)
	if (locale === "bg") return bg_command_setlighttheme2(inputs)
	if (locale === "hr") return hr_command_setlighttheme2(inputs)
	if (locale === "sr") return sr_command_setlighttheme2(inputs)
	if (locale === "sk") return sk_command_setlighttheme2(inputs)
	if (locale === "sl") return sl_command_setlighttheme2(inputs)
	if (locale === "ko") return ko_command_setlighttheme2(inputs)
	return en_command_setlighttheme2(inputs)
});
export { command_setlighttheme2 as "command_setLightTheme" }