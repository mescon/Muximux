...
/** @typedef {{}} Common_Roleuser1Inputs */

const en_common_roleuser1 = /** @type {(inputs: Common_Roleuser1Inputs) => LocalizedString} */ () => {
...
const ko_common_roleuser1 = /** @type {(inputs: Common_Roleuser1Inputs) => LocalizedString} */ () => {
...
const common_roleuser1 = /** @type {((inputs?: Common_Roleuser1Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Common_Roleuser1Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_common_roleuser1(inputs)
	if (locale === "zh") return zh_common_roleuser1(inputs)
	if (locale === "es") return es_common_roleuser1(inputs)
	if (locale === "hi") return hi_common_roleuser1(inputs)
	if (locale === "pt") return pt_common_roleuser1(inputs)
	...
	if (locale === "ar") return ar_common_roleuser1(inputs)
	if (locale === "wuu") return wuu_common_roleuser1(inputs)
	if (locale === "mr") return mr_common_roleuser1(inputs)
	if (locale === "nb") return nb_common_roleuser1(inputs)
	if (locale === "fi") return fi_common_roleuser1(inputs)
	if (locale === "da") return da_common_roleuser1(inputs)
	if (locale === "et") return et_common_roleuser1(inputs)
	if (locale === "lv") return lv_common_roleuser1(inputs)
	if (locale === "lt") return lt_common_roleuser1(inputs)
	if (locale === "pl") return pl_common_roleuser1(inputs)
	if (locale === "de") return de_common_roleuser1(inputs)
	if (locale === "nl") return nl_common_roleuser1(inputs)
	if (locale === "fr") return fr_common_roleuser1(inputs)
	if (locale === "it") return it_common_roleuser1(inputs)
	if (locale === "hu") return hu_common_roleuser1(inputs)
	if (locale === "cs") return cs_common_roleuser1(inputs)
	if (locale === "ro") return ro_common_roleuser1(inputs)
	if (locale === "el") return el_common_roleuser1(inputs)
	if (locale === "bg") return bg_common_roleuser1(inputs)
	if (locale === "hr") return hr_common_roleuser1(inputs)
	if (locale === "sr") return sr_common_roleuser1(inputs)
	if (locale === "sk") return sk_common_roleuser1(inputs)
	if (locale === "sl") return sl_common_roleuser1(inputs)
	if (locale === "ko") return ko_common_roleuser1(inputs)
	return en_common_roleuser1(inputs)
});
export { common_roleuser1 as "common_roleUser" }