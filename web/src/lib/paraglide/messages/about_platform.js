...
/** @typedef {{}} About_PlatformInputs */

const en_about_platform = /** @type {(inputs: About_PlatformInputs) => LocalizedString} */ () => {
...
const ko_about_platform = /** @type {(inputs: About_PlatformInputs) => LocalizedString} */ () => {
...
export const about_platform = /** @type {((inputs?: About_PlatformInputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<About_PlatformInputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_about_platform(inputs)
	if (locale === "zh") return zh_about_platform(inputs)
	if (locale === "es") return es_about_platform(inputs)
	if (locale === "hi") return hi_about_platform(inputs)
	if (locale === "pt") return pt_about_platform(inputs)
	...
	if (locale === "ar") return ar_about_platform(inputs)
	if (locale === "wuu") return wuu_about_platform(inputs)
	if (locale === "mr") return mr_about_platform(inputs)
	if (locale === "nb") return nb_about_platform(inputs)
	if (locale === "fi") return fi_about_platform(inputs)
	if (locale === "da") return da_about_platform(inputs)
	if (locale === "et") return et_about_platform(inputs)
	if (locale === "lv") return lv_about_platform(inputs)
	if (locale === "lt") return lt_about_platform(inputs)
	if (locale === "pl") return pl_about_platform(inputs)
	if (locale === "de") return de_about_platform(inputs)
	if (locale === "nl") return nl_about_platform(inputs)
	if (locale === "fr") return fr_about_platform(inputs)
	if (locale === "it") return it_about_platform(inputs)
	if (locale === "hu") return hu_about_platform(inputs)
	if (locale === "cs") return cs_about_platform(inputs)
	if (locale === "ro") return ro_about_platform(inputs)
	if (locale === "el") return el_about_platform(inputs)
	if (locale === "bg") return bg_about_platform(inputs)
	if (locale === "hr") return hr_about_platform(inputs)
	if (locale === "sr") return sr_about_platform(inputs)
	if (locale === "sk") return sk_about_platform(inputs)
	if (locale === "sl") return sl_about_platform(inputs)
	if (locale === "ko") return ko_about_platform(inputs)
	return en_about_platform(inputs)
});