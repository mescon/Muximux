...
/** @typedef {{}} General_Collapsibletoolbardesc2Inputs */

const en_general_collapsibletoolbardesc2 = /** @type {(inputs: General_Collapsibletoolbardesc2Inputs) => LocalizedString} */ () => {
...
const ru_general_collapsibletoolbardesc2 = /** @type {(inputs: General_Collapsibletoolbardesc2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Скрывать служебные кнопки за шестерёнкой, которая появляется при наведении`)
};
...
const ko_general_collapsibletoolbardesc2 = /** @type {(inputs: General_Collapsibletoolbardesc2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`마우스를 올리면 나타나는 톱니바퀴 뒤에 유틸리티 버튼 숨기기`)
};

/**
* | output |
* | --- |
* | "Collapse utility buttons behind a cogwheel that reveals on hover" |
*
* @param {General_Collapsibletoolbardesc2Inputs} inputs
...
*/
const general_collapsibletoolbardesc2 = /** @type {((inputs?: General_Collapsibletoolbardesc2Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<General_Collapsibletoolbardesc2Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "sv") return sv_general_collapsibletoolbardesc2(inputs)
	if (locale === "uk") return uk_general_collapsibletoolbardesc2(inputs)
	if (locale === "zh") return zh_general_collapsibletoolbardesc2(inputs)
	if (locale === "es") return es_general_collapsibletoolbardesc2(inputs)
	if (locale === "hi") return hi_general_collapsibletoolbardesc2(inputs)
	if (locale === "pt") return pt_general_collapsibletoolbardesc2(inputs)
	if (locale === "bn") return bn_general_collapsibletoolbardesc2(inputs)
	if (locale === "ru") return ru_general_collapsibletoolbardesc2(inputs)
	if (locale === "ja") return ja_general_collapsibletoolbardesc2(inputs)
	if (locale === "vi") return vi_general_collapsibletoolbardesc2(inputs)
	if (locale === "yue") return yue_general_collapsibletoolbardesc2(inputs)
	if (locale === "tr") return tr_general_collapsibletoolbardesc2(inputs)
	if (locale === "ar") return ar_general_collapsibletoolbardesc2(inputs)
	if (locale === "wuu") return wuu_general_collapsibletoolbardesc2(inputs)
	if (locale === "mr") return mr_general_collapsibletoolbardesc2(inputs)
	if (locale === "nb") return nb_general_collapsibletoolbardesc2(inputs)
	if (locale === "fi") return fi_general_collapsibletoolbardesc2(inputs)
	if (locale === "da") return da_general_collapsibletoolbardesc2(inputs)
	if (locale === "et") return et_general_collapsibletoolbardesc2(inputs)
	if (locale === "lv") return lv_general_collapsibletoolbardesc2(inputs)
	if (locale === "lt") return lt_general_collapsibletoolbardesc2(inputs)
	if (locale === "pl") return pl_general_collapsibletoolbardesc2(inputs)
	if (locale === "de") return de_general_collapsibletoolbardesc2(inputs)
	if (locale === "nl") return nl_general_collapsibletoolbardesc2(inputs)
	if (locale === "fr") return fr_general_collapsibletoolbardesc2(inputs)
	if (locale === "it") return it_general_collapsibletoolbardesc2(inputs)
	if (locale === "hu") return hu_general_collapsibletoolbardesc2(inputs)
	if (locale === "cs") return cs_general_collapsibletoolbardesc2(inputs)
	if (locale === "ro") return ro_general_collapsibletoolbardesc2(inputs)
	if (locale === "el") return el_general_collapsibletoolbardesc2(inputs)
	if (locale === "bg") return bg_general_collapsibletoolbardesc2(inputs)
	if (locale === "hr") return hr_general_collapsibletoolbardesc2(inputs)
	if (locale === "sr") return sr_general_collapsibletoolbardesc2(inputs)
	if (locale === "sk") return sk_general_collapsibletoolbardesc2(inputs)
	if (locale === "sl") return sl_general_collapsibletoolbardesc2(inputs)
	if (locale === "ko") return ko_general_collapsibletoolbardesc2(inputs)
	return en_general_collapsibletoolbardesc2(inputs)
});
export { general_collapsibletoolbardesc2 as "general_collapsibleToolbarDesc" }