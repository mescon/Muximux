...
/** @typedef {{}} About_Builddate1Inputs */

const en_about_builddate1 = /** @type {(inputs: About_Builddate1Inputs) => LocalizedString} */ () => {
...
const ko_about_builddate1 = /** @type {(inputs: About_Builddate1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`빌드 날짜`)
};
...
const about_builddate1 = /** @type {((inputs?: About_Builddate1Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<About_Builddate1Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_about_builddate1(inputs)
	if (locale === "zh") return zh_about_builddate1(inputs)
	if (locale === "es") return es_about_builddate1(inputs)
	if (locale === "hi") return hi_about_builddate1(inputs)
	if (locale === "pt") return pt_about_builddate1(inputs)
	...
	if (locale === "ar") return ar_about_builddate1(inputs)
	if (locale === "wuu") return wuu_about_builddate1(inputs)
	if (locale === "mr") return mr_about_builddate1(inputs)
	if (locale === "nb") return nb_about_builddate1(inputs)
	if (locale === "fi") return fi_about_builddate1(inputs)
	if (locale === "da") return da_about_builddate1(inputs)
	if (locale === "et") return et_about_builddate1(inputs)
	if (locale === "lv") return lv_about_builddate1(inputs)
	if (locale === "lt") return lt_about_builddate1(inputs)
	if (locale === "pl") return pl_about_builddate1(inputs)
	if (locale === "de") return de_about_builddate1(inputs)
	if (locale === "nl") return nl_about_builddate1(inputs)
	if (locale === "fr") return fr_about_builddate1(inputs)
	if (locale === "it") return it_about_builddate1(inputs)
	if (locale === "hu") return hu_about_builddate1(inputs)
	if (locale === "cs") return cs_about_builddate1(inputs)
	if (locale === "ro") return ro_about_builddate1(inputs)
	if (locale === "el") return el_about_builddate1(inputs)
	if (locale === "bg") return bg_about_builddate1(inputs)
	if (locale === "hr") return hr_about_builddate1(inputs)
	if (locale === "sr") return sr_about_builddate1(inputs)
	if (locale === "sk") return sk_about_builddate1(inputs)
	if (locale === "sl") return sl_about_builddate1(inputs)
	if (locale === "ko") return ko_about_builddate1(inputs)
	return en_about_builddate1(inputs)
});
export { about_builddate1 as "about_buildDate" }