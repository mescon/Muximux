...
/** @typedef {{}} Theme_EditorInputs */

const en_theme_editor = /** @type {(inputs: Theme_EditorInputs) => LocalizedString} */ () => {
...
const ko_theme_editor = /** @type {(inputs: Theme_EditorInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`테마 편집기`)
};
...
export const theme_editor = /** @type {((inputs?: Theme_EditorInputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Theme_EditorInputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_theme_editor(inputs)
	if (locale === "zh") return zh_theme_editor(inputs)
	if (locale === "es") return es_theme_editor(inputs)
	if (locale === "hi") return hi_theme_editor(inputs)
	if (locale === "pt") return pt_theme_editor(inputs)
	...
	if (locale === "ar") return ar_theme_editor(inputs)
	if (locale === "wuu") return wuu_theme_editor(inputs)
	if (locale === "mr") return mr_theme_editor(inputs)
	if (locale === "nb") return nb_theme_editor(inputs)
	if (locale === "fi") return fi_theme_editor(inputs)
	if (locale === "da") return da_theme_editor(inputs)
	if (locale === "et") return et_theme_editor(inputs)
	if (locale === "lv") return lv_theme_editor(inputs)
	if (locale === "lt") return lt_theme_editor(inputs)
	if (locale === "pl") return pl_theme_editor(inputs)
	if (locale === "de") return de_theme_editor(inputs)
	if (locale === "nl") return nl_theme_editor(inputs)
	if (locale === "fr") return fr_theme_editor(inputs)
	if (locale === "it") return it_theme_editor(inputs)
	if (locale === "hu") return hu_theme_editor(inputs)
	if (locale === "cs") return cs_theme_editor(inputs)
	if (locale === "ro") return ro_theme_editor(inputs)
	if (locale === "el") return el_theme_editor(inputs)
	if (locale === "bg") return bg_theme_editor(inputs)
	if (locale === "hr") return hr_theme_editor(inputs)
	if (locale === "sr") return sr_theme_editor(inputs)
	if (locale === "sk") return sk_theme_editor(inputs)
	if (locale === "sl") return sl_theme_editor(inputs)
	if (locale === "ko") return ko_theme_editor(inputs)
	return en_theme_editor(inputs)
});