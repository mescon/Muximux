...
/** @typedef {{}} About_ReleasesInputs */

const en_about_releases = /** @type {(inputs: About_ReleasesInputs) => LocalizedString} */ () => {
...
const nl_about_releases = /** @type {(inputs: About_ReleasesInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Releases`)
};

const fr_about_releases = /** @type {(inputs: About_ReleasesInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Releases`)
};

const it_about_releases = /** @type {(inputs: About_ReleasesInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Releases`)
};
...
const ko_about_releases = /** @type {(inputs: About_ReleasesInputs) => LocalizedString} */ () => {
...
export const about_releases = /** @type {((inputs?: About_ReleasesInputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<About_ReleasesInputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_about_releases(inputs)
	if (locale === "zh") return zh_about_releases(inputs)
	if (locale === "es") return es_about_releases(inputs)
	if (locale === "hi") return hi_about_releases(inputs)
	if (locale === "pt") return pt_about_releases(inputs)
	...
	if (locale === "ar") return ar_about_releases(inputs)
	if (locale === "wuu") return wuu_about_releases(inputs)
	if (locale === "mr") return mr_about_releases(inputs)
	if (locale === "nb") return nb_about_releases(inputs)
	if (locale === "fi") return fi_about_releases(inputs)
	if (locale === "da") return da_about_releases(inputs)
	if (locale === "et") return et_about_releases(inputs)
	if (locale === "lv") return lv_about_releases(inputs)
	if (locale === "lt") return lt_about_releases(inputs)
	if (locale === "pl") return pl_about_releases(inputs)
	if (locale === "de") return de_about_releases(inputs)
	if (locale === "nl") return nl_about_releases(inputs)
	if (locale === "fr") return fr_about_releases(inputs)
	if (locale === "it") return it_about_releases(inputs)
	if (locale === "hu") return hu_about_releases(inputs)
	if (locale === "cs") return cs_about_releases(inputs)
	if (locale === "ro") return ro_about_releases(inputs)
	if (locale === "el") return el_about_releases(inputs)
	if (locale === "bg") return bg_about_releases(inputs)
	if (locale === "hr") return hr_about_releases(inputs)
	if (locale === "sr") return sr_about_releases(inputs)
	if (locale === "sk") return sk_about_releases(inputs)
	if (locale === "sl") return sl_about_releases(inputs)
	if (locale === "ko") return ko_about_releases(inputs)
	return en_about_releases(inputs)
});