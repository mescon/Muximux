...
/** @typedef {{}} Apps_Addgroup1Inputs */

const en_apps_addgroup1 = /** @type {(inputs: Apps_Addgroup1Inputs) => LocalizedString} */ () => {
...
const ko_apps_addgroup1 = /** @type {(inputs: Apps_Addgroup1Inputs) => LocalizedString} */ () => {
...
const apps_addgroup1 = /** @type {((inputs?: Apps_Addgroup1Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Apps_Addgroup1Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_apps_addgroup1(inputs)
	if (locale === "zh") return zh_apps_addgroup1(inputs)
	if (locale === "es") return es_apps_addgroup1(inputs)
	if (locale === "hi") return hi_apps_addgroup1(inputs)
	if (locale === "pt") return pt_apps_addgroup1(inputs)
	...
	if (locale === "ar") return ar_apps_addgroup1(inputs)
	if (locale === "wuu") return wuu_apps_addgroup1(inputs)
	if (locale === "mr") return mr_apps_addgroup1(inputs)
	if (locale === "nb") return nb_apps_addgroup1(inputs)
	if (locale === "fi") return fi_apps_addgroup1(inputs)
	if (locale === "da") return da_apps_addgroup1(inputs)
	if (locale === "et") return et_apps_addgroup1(inputs)
	if (locale === "lv") return lv_apps_addgroup1(inputs)
	if (locale === "lt") return lt_apps_addgroup1(inputs)
	if (locale === "pl") return pl_apps_addgroup1(inputs)
	if (locale === "de") return de_apps_addgroup1(inputs)
	if (locale === "nl") return nl_apps_addgroup1(inputs)
	if (locale === "fr") return fr_apps_addgroup1(inputs)
	if (locale === "it") return it_apps_addgroup1(inputs)
	if (locale === "hu") return hu_apps_addgroup1(inputs)
	if (locale === "cs") return cs_apps_addgroup1(inputs)
	if (locale === "ro") return ro_apps_addgroup1(inputs)
	if (locale === "el") return el_apps_addgroup1(inputs)
	if (locale === "bg") return bg_apps_addgroup1(inputs)
	if (locale === "hr") return hr_apps_addgroup1(inputs)
	if (locale === "sr") return sr_apps_addgroup1(inputs)
	if (locale === "sk") return sk_apps_addgroup1(inputs)
	if (locale === "sl") return sl_apps_addgroup1(inputs)
	if (locale === "ko") return ko_apps_addgroup1(inputs)
	return en_apps_addgroup1(inputs)
});
export { apps_addgroup1 as "apps_addGroup" }