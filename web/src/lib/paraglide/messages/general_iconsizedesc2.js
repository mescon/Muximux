...
/** @typedef {{}} General_Iconsizedesc2Inputs */

const en_general_iconsizedesc2 = /** @type {(inputs: General_Iconsizedesc2Inputs) => LocalizedString} */ () => {
...
const ru_general_iconsizedesc2 = /** @type {(inputs: General_Iconsizedesc2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Масштаб иконок приложений в навигации`)
};
...
const ko_general_iconsizedesc2 = /** @type {(inputs: General_Iconsizedesc2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`내비게이션의 앱 아이콘 크기 조정`)
};
...
const general_iconsizedesc2 = /** @type {((inputs?: General_Iconsizedesc2Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<General_Iconsizedesc2Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_general_iconsizedesc2(inputs)
	if (locale === "zh") return zh_general_iconsizedesc2(inputs)
	if (locale === "es") return es_general_iconsizedesc2(inputs)
	if (locale === "hi") return hi_general_iconsizedesc2(inputs)
	if (locale === "pt") return pt_general_iconsizedesc2(inputs)
	...
	if (locale === "ar") return ar_general_iconsizedesc2(inputs)
	if (locale === "wuu") return wuu_general_iconsizedesc2(inputs)
	if (locale === "mr") return mr_general_iconsizedesc2(inputs)
	if (locale === "nb") return nb_general_iconsizedesc2(inputs)
	if (locale === "fi") return fi_general_iconsizedesc2(inputs)
	if (locale === "da") return da_general_iconsizedesc2(inputs)
	if (locale === "et") return et_general_iconsizedesc2(inputs)
	if (locale === "lv") return lv_general_iconsizedesc2(inputs)
	if (locale === "lt") return lt_general_iconsizedesc2(inputs)
	if (locale === "pl") return pl_general_iconsizedesc2(inputs)
	if (locale === "de") return de_general_iconsizedesc2(inputs)
	if (locale === "nl") return nl_general_iconsizedesc2(inputs)
	if (locale === "fr") return fr_general_iconsizedesc2(inputs)
	if (locale === "it") return it_general_iconsizedesc2(inputs)
	if (locale === "hu") return hu_general_iconsizedesc2(inputs)
	if (locale === "cs") return cs_general_iconsizedesc2(inputs)
	if (locale === "ro") return ro_general_iconsizedesc2(inputs)
	if (locale === "el") return el_general_iconsizedesc2(inputs)
	if (locale === "bg") return bg_general_iconsizedesc2(inputs)
	if (locale === "hr") return hr_general_iconsizedesc2(inputs)
	if (locale === "sr") return sr_general_iconsizedesc2(inputs)
	if (locale === "sk") return sk_general_iconsizedesc2(inputs)
	if (locale === "sl") return sl_general_iconsizedesc2(inputs)
	if (locale === "ko") return ko_general_iconsizedesc2(inputs)
	return en_general_iconsizedesc2(inputs)
});
export { general_iconsizedesc2 as "general_iconSizeDesc" }