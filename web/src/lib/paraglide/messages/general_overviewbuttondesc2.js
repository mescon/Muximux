...
/** @typedef {{}} General_Overviewbuttondesc2Inputs */

const en_general_overviewbuttondesc2 = /** @type {(inputs: General_Overviewbuttondesc2Inputs) => LocalizedString} */ () => {
...
const ru_general_overviewbuttondesc2 = /** @type {(inputs: General_Overviewbuttondesc2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Выберите, как кнопка обзора будет отображаться в панели навигации`)
};
...
const ko_general_overviewbuttondesc2 = /** @type {(inputs: General_Overviewbuttondesc2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`내비게이션 바에 개요 버튼이 표시되는 방식을 선택하세요`)
};

/**
* | output |
* | --- |
* | "Choose how the overview button appears in the navigation bar" |
*
* @param {General_Overviewbuttondesc2Inputs} inputs
...
*/
const general_overviewbuttondesc2 = /** @type {((inputs?: General_Overviewbuttondesc2Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<General_Overviewbuttondesc2Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_general_overviewbuttondesc2(inputs)
	if (locale === "sv") return sv_general_overviewbuttondesc2(inputs)
	if (locale === "uk") return uk_general_overviewbuttondesc2(inputs)
	if (locale === "zh") return zh_general_overviewbuttondesc2(inputs)
	if (locale === "es") return es_general_overviewbuttondesc2(inputs)
	if (locale === "hi") return hi_general_overviewbuttondesc2(inputs)
	if (locale === "pt") return pt_general_overviewbuttondesc2(inputs)
	if (locale === "bn") return bn_general_overviewbuttondesc2(inputs)
	if (locale === "ru") return ru_general_overviewbuttondesc2(inputs)
	if (locale === "ja") return ja_general_overviewbuttondesc2(inputs)
	if (locale === "vi") return vi_general_overviewbuttondesc2(inputs)
	if (locale === "yue") return yue_general_overviewbuttondesc2(inputs)
	if (locale === "tr") return tr_general_overviewbuttondesc2(inputs)
	if (locale === "ar") return ar_general_overviewbuttondesc2(inputs)
	if (locale === "wuu") return wuu_general_overviewbuttondesc2(inputs)
	if (locale === "mr") return mr_general_overviewbuttondesc2(inputs)
	if (locale === "nb") return nb_general_overviewbuttondesc2(inputs)
	if (locale === "fi") return fi_general_overviewbuttondesc2(inputs)
	if (locale === "da") return da_general_overviewbuttondesc2(inputs)
	if (locale === "et") return et_general_overviewbuttondesc2(inputs)
	if (locale === "lv") return lv_general_overviewbuttondesc2(inputs)
	if (locale === "lt") return lt_general_overviewbuttondesc2(inputs)
	if (locale === "pl") return pl_general_overviewbuttondesc2(inputs)
	if (locale === "de") return de_general_overviewbuttondesc2(inputs)
	if (locale === "nl") return nl_general_overviewbuttondesc2(inputs)
	if (locale === "fr") return fr_general_overviewbuttondesc2(inputs)
	if (locale === "it") return it_general_overviewbuttondesc2(inputs)
	if (locale === "hu") return hu_general_overviewbuttondesc2(inputs)
	if (locale === "cs") return cs_general_overviewbuttondesc2(inputs)
	if (locale === "ro") return ro_general_overviewbuttondesc2(inputs)
	if (locale === "el") return el_general_overviewbuttondesc2(inputs)
	if (locale === "bg") return bg_general_overviewbuttondesc2(inputs)
	if (locale === "hr") return hr_general_overviewbuttondesc2(inputs)
	if (locale === "sr") return sr_general_overviewbuttondesc2(inputs)
	if (locale === "sk") return sk_general_overviewbuttondesc2(inputs)
	if (locale === "sl") return sl_general_overviewbuttondesc2(inputs)
	return ko_general_overviewbuttondesc2(inputs)
});
export { general_overviewbuttondesc2 as "general_overviewButtonDesc" }