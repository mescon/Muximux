...
/** @typedef {{}} Theme_Statussuccess1Inputs */

const en_theme_statussuccess1 = /** @type {(inputs: Theme_Statussuccess1Inputs) => LocalizedString} */ () => {
...
const ko_theme_statussuccess1 = /** @type {(inputs: Theme_Statussuccess1Inputs) => LocalizedString} */ () => {
...
const theme_statussuccess1 = /** @type {((inputs?: Theme_Statussuccess1Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Theme_Statussuccess1Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_theme_statussuccess1(inputs)
	if (locale === "zh") return zh_theme_statussuccess1(inputs)
	if (locale === "es") return es_theme_statussuccess1(inputs)
	if (locale === "hi") return hi_theme_statussuccess1(inputs)
	if (locale === "pt") return pt_theme_statussuccess1(inputs)
	...
	if (locale === "ar") return ar_theme_statussuccess1(inputs)
	if (locale === "wuu") return wuu_theme_statussuccess1(inputs)
	if (locale === "mr") return mr_theme_statussuccess1(inputs)
	if (locale === "nb") return nb_theme_statussuccess1(inputs)
	if (locale === "fi") return fi_theme_statussuccess1(inputs)
	if (locale === "da") return da_theme_statussuccess1(inputs)
	if (locale === "et") return et_theme_statussuccess1(inputs)
	if (locale === "lv") return lv_theme_statussuccess1(inputs)
	if (locale === "lt") return lt_theme_statussuccess1(inputs)
	if (locale === "pl") return pl_theme_statussuccess1(inputs)
	if (locale === "de") return de_theme_statussuccess1(inputs)
	if (locale === "nl") return nl_theme_statussuccess1(inputs)
	if (locale === "fr") return fr_theme_statussuccess1(inputs)
	if (locale === "it") return it_theme_statussuccess1(inputs)
	if (locale === "hu") return hu_theme_statussuccess1(inputs)
	if (locale === "cs") return cs_theme_statussuccess1(inputs)
	if (locale === "ro") return ro_theme_statussuccess1(inputs)
	if (locale === "el") return el_theme_statussuccess1(inputs)
	if (locale === "bg") return bg_theme_statussuccess1(inputs)
	if (locale === "hr") return hr_theme_statussuccess1(inputs)
	if (locale === "sr") return sr_theme_statussuccess1(inputs)
	if (locale === "sk") return sk_theme_statussuccess1(inputs)
	if (locale === "sl") return sl_theme_statussuccess1(inputs)
	if (locale === "ko") return ko_theme_statussuccess1(inputs)
	return en_theme_statussuccess1(inputs)
});
export { theme_statussuccess1 as "theme_statusSuccess" }