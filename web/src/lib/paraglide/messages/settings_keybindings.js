...
/** @typedef {{}} Settings_KeybindingsInputs */

const en_settings_keybindings = /** @type {(inputs: Settings_KeybindingsInputs) => LocalizedString} */ () => {
...
const ko_settings_keybindings = /** @type {(inputs: Settings_KeybindingsInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`단축키`)
};
...
export const settings_keybindings = /** @type {((inputs?: Settings_KeybindingsInputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Settings_KeybindingsInputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_settings_keybindings(inputs)
	if (locale === "zh") return zh_settings_keybindings(inputs)
	if (locale === "es") return es_settings_keybindings(inputs)
	if (locale === "hi") return hi_settings_keybindings(inputs)
	if (locale === "pt") return pt_settings_keybindings(inputs)
	...
	if (locale === "ar") return ar_settings_keybindings(inputs)
	if (locale === "wuu") return wuu_settings_keybindings(inputs)
	if (locale === "mr") return mr_settings_keybindings(inputs)
	if (locale === "nb") return nb_settings_keybindings(inputs)
	if (locale === "fi") return fi_settings_keybindings(inputs)
	if (locale === "da") return da_settings_keybindings(inputs)
	if (locale === "et") return et_settings_keybindings(inputs)
	if (locale === "lv") return lv_settings_keybindings(inputs)
	if (locale === "lt") return lt_settings_keybindings(inputs)
	if (locale === "pl") return pl_settings_keybindings(inputs)
	if (locale === "de") return de_settings_keybindings(inputs)
	if (locale === "nl") return nl_settings_keybindings(inputs)
	if (locale === "fr") return fr_settings_keybindings(inputs)
	if (locale === "it") return it_settings_keybindings(inputs)
	if (locale === "hu") return hu_settings_keybindings(inputs)
	if (locale === "cs") return cs_settings_keybindings(inputs)
	if (locale === "ro") return ro_settings_keybindings(inputs)
	if (locale === "el") return el_settings_keybindings(inputs)
	if (locale === "bg") return bg_settings_keybindings(inputs)
	if (locale === "hr") return hr_settings_keybindings(inputs)
	if (locale === "sr") return sr_settings_keybindings(inputs)
	if (locale === "sk") return sk_settings_keybindings(inputs)
	if (locale === "sl") return sl_settings_keybindings(inputs)
	if (locale === "ko") return ko_settings_keybindings(inputs)
	return en_settings_keybindings(inputs)
});