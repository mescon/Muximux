...
/** @typedef {{ shortcut: NonNullable<unknown> }} Nav_Searchwithshortcut2Inputs */

const en_nav_searchwithshortcut2 = /** @type {(inputs: Nav_Searchwithshortcut2Inputs) => LocalizedString} */ (i) => {
...
const ko_nav_searchwithshortcut2 = /** @type {(inputs: Nav_Searchwithshortcut2Inputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`검색 (${i?.shortcut})`)
};
...
const nav_searchwithshortcut2 = /** @type {((inputs: Nav_Searchwithshortcut2Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Nav_Searchwithshortcut2Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs, options = {}) => {
	...
	if (locale === "uk") return uk_nav_searchwithshortcut2(inputs)
	if (locale === "zh") return zh_nav_searchwithshortcut2(inputs)
	if (locale === "es") return es_nav_searchwithshortcut2(inputs)
	if (locale === "hi") return hi_nav_searchwithshortcut2(inputs)
	if (locale === "pt") return pt_nav_searchwithshortcut2(inputs)
	...
	if (locale === "ar") return ar_nav_searchwithshortcut2(inputs)
	if (locale === "wuu") return wuu_nav_searchwithshortcut2(inputs)
	if (locale === "mr") return mr_nav_searchwithshortcut2(inputs)
	if (locale === "nb") return nb_nav_searchwithshortcut2(inputs)
	if (locale === "fi") return fi_nav_searchwithshortcut2(inputs)
	if (locale === "da") return da_nav_searchwithshortcut2(inputs)
	if (locale === "et") return et_nav_searchwithshortcut2(inputs)
	if (locale === "lv") return lv_nav_searchwithshortcut2(inputs)
	if (locale === "lt") return lt_nav_searchwithshortcut2(inputs)
	if (locale === "pl") return pl_nav_searchwithshortcut2(inputs)
	if (locale === "de") return de_nav_searchwithshortcut2(inputs)
	if (locale === "nl") return nl_nav_searchwithshortcut2(inputs)
	if (locale === "fr") return fr_nav_searchwithshortcut2(inputs)
	if (locale === "it") return it_nav_searchwithshortcut2(inputs)
	if (locale === "hu") return hu_nav_searchwithshortcut2(inputs)
	if (locale === "cs") return cs_nav_searchwithshortcut2(inputs)
	if (locale === "ro") return ro_nav_searchwithshortcut2(inputs)
	if (locale === "el") return el_nav_searchwithshortcut2(inputs)
	if (locale === "bg") return bg_nav_searchwithshortcut2(inputs)
	if (locale === "hr") return hr_nav_searchwithshortcut2(inputs)
	if (locale === "sr") return sr_nav_searchwithshortcut2(inputs)
	if (locale === "sk") return sk_nav_searchwithshortcut2(inputs)
	if (locale === "sl") return sl_nav_searchwithshortcut2(inputs)
	if (locale === "ko") return ko_nav_searchwithshortcut2(inputs)
	return en_nav_searchwithshortcut2(inputs)
});
export { nav_searchwithshortcut2 as "nav_searchWithShortcut" }