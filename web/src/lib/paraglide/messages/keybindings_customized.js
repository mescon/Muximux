...
/** @typedef {{}} Keybindings_CustomizedInputs */

const en_keybindings_customized = /** @type {(inputs: Keybindings_CustomizedInputs) => LocalizedString} */ () => {
...
const ko_keybindings_customized = /** @type {(inputs: Keybindings_CustomizedInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`(사용자 지정됨)`)
};
...
export const keybindings_customized = /** @type {((inputs?: Keybindings_CustomizedInputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Keybindings_CustomizedInputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_keybindings_customized(inputs)
	if (locale === "zh") return zh_keybindings_customized(inputs)
	if (locale === "es") return es_keybindings_customized(inputs)
	if (locale === "hi") return hi_keybindings_customized(inputs)
	if (locale === "pt") return pt_keybindings_customized(inputs)
	...
	if (locale === "ar") return ar_keybindings_customized(inputs)
	if (locale === "wuu") return wuu_keybindings_customized(inputs)
	if (locale === "mr") return mr_keybindings_customized(inputs)
	if (locale === "nb") return nb_keybindings_customized(inputs)
	if (locale === "fi") return fi_keybindings_customized(inputs)
	if (locale === "da") return da_keybindings_customized(inputs)
	if (locale === "et") return et_keybindings_customized(inputs)
	if (locale === "lv") return lv_keybindings_customized(inputs)
	if (locale === "lt") return lt_keybindings_customized(inputs)
	if (locale === "pl") return pl_keybindings_customized(inputs)
	if (locale === "de") return de_keybindings_customized(inputs)
	if (locale === "nl") return nl_keybindings_customized(inputs)
	if (locale === "fr") return fr_keybindings_customized(inputs)
	if (locale === "it") return it_keybindings_customized(inputs)
	if (locale === "hu") return hu_keybindings_customized(inputs)
	if (locale === "cs") return cs_keybindings_customized(inputs)
	if (locale === "ro") return ro_keybindings_customized(inputs)
	if (locale === "el") return el_keybindings_customized(inputs)
	if (locale === "bg") return bg_keybindings_customized(inputs)
	if (locale === "hr") return hr_keybindings_customized(inputs)
	if (locale === "sr") return sr_keybindings_customized(inputs)
	if (locale === "sk") return sk_keybindings_customized(inputs)
	if (locale === "sl") return sl_keybindings_customized(inputs)
	if (locale === "ko") return ko_keybindings_customized(inputs)
	return en_keybindings_customized(inputs)
});