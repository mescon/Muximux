...
/** @typedef {{}} Onboarding_Reenterpassword1Inputs */

const en_onboarding_reenterpassword1 = /** @type {(inputs: Onboarding_Reenterpassword1Inputs) => LocalizedString} */ () => {
...
const ko_onboarding_reenterpassword1 = /** @type {(inputs: Onboarding_Reenterpassword1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`비밀번호 다시 입력`)
};
...
const onboarding_reenterpassword1 = /** @type {((inputs?: Onboarding_Reenterpassword1Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Onboarding_Reenterpassword1Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_onboarding_reenterpassword1(inputs)
	if (locale === "zh") return zh_onboarding_reenterpassword1(inputs)
	if (locale === "es") return es_onboarding_reenterpassword1(inputs)
	if (locale === "hi") return hi_onboarding_reenterpassword1(inputs)
	if (locale === "pt") return pt_onboarding_reenterpassword1(inputs)
	...
	if (locale === "ar") return ar_onboarding_reenterpassword1(inputs)
	if (locale === "wuu") return wuu_onboarding_reenterpassword1(inputs)
	if (locale === "mr") return mr_onboarding_reenterpassword1(inputs)
	if (locale === "nb") return nb_onboarding_reenterpassword1(inputs)
	if (locale === "fi") return fi_onboarding_reenterpassword1(inputs)
	if (locale === "da") return da_onboarding_reenterpassword1(inputs)
	if (locale === "et") return et_onboarding_reenterpassword1(inputs)
	if (locale === "lv") return lv_onboarding_reenterpassword1(inputs)
	if (locale === "lt") return lt_onboarding_reenterpassword1(inputs)
	if (locale === "pl") return pl_onboarding_reenterpassword1(inputs)
	if (locale === "de") return de_onboarding_reenterpassword1(inputs)
	if (locale === "nl") return nl_onboarding_reenterpassword1(inputs)
	if (locale === "fr") return fr_onboarding_reenterpassword1(inputs)
	if (locale === "it") return it_onboarding_reenterpassword1(inputs)
	if (locale === "hu") return hu_onboarding_reenterpassword1(inputs)
	if (locale === "cs") return cs_onboarding_reenterpassword1(inputs)
	if (locale === "ro") return ro_onboarding_reenterpassword1(inputs)
	if (locale === "el") return el_onboarding_reenterpassword1(inputs)
	if (locale === "bg") return bg_onboarding_reenterpassword1(inputs)
	if (locale === "hr") return hr_onboarding_reenterpassword1(inputs)
	if (locale === "sr") return sr_onboarding_reenterpassword1(inputs)
	if (locale === "sk") return sk_onboarding_reenterpassword1(inputs)
	if (locale === "sl") return sl_onboarding_reenterpassword1(inputs)
	if (locale === "ko") return ko_onboarding_reenterpassword1(inputs)
	return en_onboarding_reenterpassword1(inputs)
});
export { onboarding_reenterpassword1 as "onboarding_reenterPassword" }