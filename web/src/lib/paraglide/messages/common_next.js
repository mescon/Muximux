...
export const common_next = /** @type {((inputs?: Common_NextInputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Common_NextInputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_common_next(inputs)
	...
	if (locale === "pt") return pt_common_next(inputs)
	...
	if (locale === "ar") return ar_common_next(inputs)
	if (locale === "wuu") return wuu_common_next(inputs)
	if (locale === "mr") return mr_common_next(inputs)
	if (locale === "nb") return nb_common_next(inputs)
	if (locale === "fi") return fi_common_next(inputs)
	if (locale === "da") return da_common_next(inputs)
	if (locale === "et") return et_common_next(inputs)
	if (locale === "lv") return lv_common_next(inputs)
	if (locale === "lt") return lt_common_next(inputs)
	if (locale === "pl") return pl_common_next(inputs)
	if (locale === "de") return de_common_next(inputs)
	if (locale === "nl") return nl_common_next(inputs)
	if (locale === "fr") return fr_common_next(inputs)
	if (locale === "it") return it_common_next(inputs)
	if (locale === "hu") return hu_common_next(inputs)
	if (locale === "cs") return cs_common_next(inputs)
	if (locale === "ro") return ro_common_next(inputs)
	if (locale === "el") return el_common_next(inputs)
	if (locale === "bg") return bg_common_next(inputs)
	if (locale === "hr") return hr_common_next(inputs)
	if (locale === "sr") return sr_common_next(inputs)
	if (locale === "sk") return sk_common_next(inputs)
	if (locale === "sl") return sl_common_next(inputs)
	return ko_common_next(inputs)
});