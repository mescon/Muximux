...
/** @typedef {{}} Splash_Noappsdesc2Inputs */

const en_splash_noappsdesc2 = /** @type {(inputs: Splash_Noappsdesc2Inputs) => LocalizedString} */ () => {
...
const ru_splash_noappsdesc2 = /** @type {(inputs: Splash_Noappsdesc2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Добавьте своё первое приложение, чтобы начать работу с панелью.`)
};
...
const ko_splash_noappsdesc2 = /** @type {(inputs: Splash_Noappsdesc2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`대시보드를 시작하려면 첫 번째 애플리케이션을 추가하세요.`)
};
...
const splash_noappsdesc2 = /** @type {((inputs?: Splash_Noappsdesc2Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Splash_Noappsdesc2Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_splash_noappsdesc2(inputs)
	if (locale === "zh") return zh_splash_noappsdesc2(inputs)
	if (locale === "es") return es_splash_noappsdesc2(inputs)
	if (locale === "hi") return hi_splash_noappsdesc2(inputs)
	if (locale === "pt") return pt_splash_noappsdesc2(inputs)
	...
	if (locale === "ar") return ar_splash_noappsdesc2(inputs)
	if (locale === "wuu") return wuu_splash_noappsdesc2(inputs)
	if (locale === "mr") return mr_splash_noappsdesc2(inputs)
	if (locale === "nb") return nb_splash_noappsdesc2(inputs)
	if (locale === "fi") return fi_splash_noappsdesc2(inputs)
	if (locale === "da") return da_splash_noappsdesc2(inputs)
	if (locale === "et") return et_splash_noappsdesc2(inputs)
	if (locale === "lv") return lv_splash_noappsdesc2(inputs)
	if (locale === "lt") return lt_splash_noappsdesc2(inputs)
	if (locale === "pl") return pl_splash_noappsdesc2(inputs)
	if (locale === "de") return de_splash_noappsdesc2(inputs)
	if (locale === "nl") return nl_splash_noappsdesc2(inputs)
	if (locale === "fr") return fr_splash_noappsdesc2(inputs)
	if (locale === "it") return it_splash_noappsdesc2(inputs)
	if (locale === "hu") return hu_splash_noappsdesc2(inputs)
	if (locale === "cs") return cs_splash_noappsdesc2(inputs)
	if (locale === "ro") return ro_splash_noappsdesc2(inputs)
	if (locale === "el") return el_splash_noappsdesc2(inputs)
	if (locale === "bg") return bg_splash_noappsdesc2(inputs)
	if (locale === "hr") return hr_splash_noappsdesc2(inputs)
	if (locale === "sr") return sr_splash_noappsdesc2(inputs)
	if (locale === "sk") return sk_splash_noappsdesc2(inputs)
	if (locale === "sl") return sl_splash_noappsdesc2(inputs)
	if (locale === "ko") return ko_splash_noappsdesc2(inputs)
	return en_splash_noappsdesc2(inputs)
});
export { splash_noappsdesc2 as "splash_noAppsDesc" }