...
/** @typedef {{}} Shortcuts_Customizehint1Inputs */

const en_shortcuts_customizehint1 = /** @type {(inputs: Shortcuts_Customizehint1Inputs) => LocalizedString} */ () => {
...
const ru_shortcuts_customizehint1 = /** @type {(inputs: Shortcuts_Customizehint1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Настройте сочетания клавиш в`)
};
...
const ko_shortcuts_customizehint1 = /** @type {(inputs: Shortcuts_Customizehint1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`단축키 사용자 지정은`)
};
...
const shortcuts_customizehint1 = /** @type {((inputs?: Shortcuts_Customizehint1Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Shortcuts_Customizehint1Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_shortcuts_customizehint1(inputs)
	if (locale === "zh") return zh_shortcuts_customizehint1(inputs)
	if (locale === "es") return es_shortcuts_customizehint1(inputs)
	if (locale === "hi") return hi_shortcuts_customizehint1(inputs)
	if (locale === "pt") return pt_shortcuts_customizehint1(inputs)
	...
	if (locale === "ar") return ar_shortcuts_customizehint1(inputs)
	if (locale === "wuu") return wuu_shortcuts_customizehint1(inputs)
	if (locale === "mr") return mr_shortcuts_customizehint1(inputs)
	if (locale === "nb") return nb_shortcuts_customizehint1(inputs)
	if (locale === "fi") return fi_shortcuts_customizehint1(inputs)
	if (locale === "da") return da_shortcuts_customizehint1(inputs)
	if (locale === "et") return et_shortcuts_customizehint1(inputs)
	if (locale === "lv") return lv_shortcuts_customizehint1(inputs)
	if (locale === "lt") return lt_shortcuts_customizehint1(inputs)
	if (locale === "pl") return pl_shortcuts_customizehint1(inputs)
	if (locale === "de") return de_shortcuts_customizehint1(inputs)
	if (locale === "nl") return nl_shortcuts_customizehint1(inputs)
	if (locale === "fr") return fr_shortcuts_customizehint1(inputs)
	if (locale === "it") return it_shortcuts_customizehint1(inputs)
	if (locale === "hu") return hu_shortcuts_customizehint1(inputs)
	if (locale === "cs") return cs_shortcuts_customizehint1(inputs)
	if (locale === "ro") return ro_shortcuts_customizehint1(inputs)
	if (locale === "el") return el_shortcuts_customizehint1(inputs)
	if (locale === "bg") return bg_shortcuts_customizehint1(inputs)
	if (locale === "hr") return hr_shortcuts_customizehint1(inputs)
	if (locale === "sr") return sr_shortcuts_customizehint1(inputs)
	if (locale === "sk") return sk_shortcuts_customizehint1(inputs)
	if (locale === "sl") return sl_shortcuts_customizehint1(inputs)
	if (locale === "ko") return ko_shortcuts_customizehint1(inputs)
	return en_shortcuts_customizehint1(inputs)
});
export { shortcuts_customizehint1 as "shortcuts_customizeHint" }