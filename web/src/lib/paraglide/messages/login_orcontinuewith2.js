...
/** @typedef {{}} Login_Orcontinuewith2Inputs */

const en_login_orcontinuewith2 = /** @type {(inputs: Login_Orcontinuewith2Inputs) => LocalizedString} */ () => {
...
const ru_login_orcontinuewith2 = /** @type {(inputs: Login_Orcontinuewith2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`или продолжите с именем пользователя`)
};
...
const ko_login_orcontinuewith2 = /** @type {(inputs: Login_Orcontinuewith2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`또는 사용자 이름으로 계속하기`)
};
...
const login_orcontinuewith2 = /** @type {((inputs?: Login_Orcontinuewith2Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Login_Orcontinuewith2Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_login_orcontinuewith2(inputs)
	if (locale === "zh") return zh_login_orcontinuewith2(inputs)
	if (locale === "es") return es_login_orcontinuewith2(inputs)
	if (locale === "hi") return hi_login_orcontinuewith2(inputs)
	if (locale === "pt") return pt_login_orcontinuewith2(inputs)
	...
	if (locale === "ar") return ar_login_orcontinuewith2(inputs)
	if (locale === "wuu") return wuu_login_orcontinuewith2(inputs)
	if (locale === "mr") return mr_login_orcontinuewith2(inputs)
	if (locale === "nb") return nb_login_orcontinuewith2(inputs)
	if (locale === "fi") return fi_login_orcontinuewith2(inputs)
	if (locale === "da") return da_login_orcontinuewith2(inputs)
	if (locale === "et") return et_login_orcontinuewith2(inputs)
	if (locale === "lv") return lv_login_orcontinuewith2(inputs)
	if (locale === "lt") return lt_login_orcontinuewith2(inputs)
	if (locale === "pl") return pl_login_orcontinuewith2(inputs)
	if (locale === "de") return de_login_orcontinuewith2(inputs)
	if (locale === "nl") return nl_login_orcontinuewith2(inputs)
	if (locale === "fr") return fr_login_orcontinuewith2(inputs)
	if (locale === "it") return it_login_orcontinuewith2(inputs)
	if (locale === "hu") return hu_login_orcontinuewith2(inputs)
	if (locale === "cs") return cs_login_orcontinuewith2(inputs)
	if (locale === "ro") return ro_login_orcontinuewith2(inputs)
	if (locale === "el") return el_login_orcontinuewith2(inputs)
	if (locale === "bg") return bg_login_orcontinuewith2(inputs)
	if (locale === "hr") return hr_login_orcontinuewith2(inputs)
	if (locale === "sr") return sr_login_orcontinuewith2(inputs)
	if (locale === "sk") return sk_login_orcontinuewith2(inputs)
	if (locale === "sl") return sl_login_orcontinuewith2(inputs)
	if (locale === "ko") return ko_login_orcontinuewith2(inputs)
	return en_login_orcontinuewith2(inputs)
});
export { login_orcontinuewith2 as "login_orContinueWith" }