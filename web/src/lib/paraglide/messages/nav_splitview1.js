...
/** @typedef {{}} Nav_Splitview1Inputs */

const en_nav_splitview1 = /** @type {(inputs: Nav_Splitview1Inputs) => LocalizedString} */ () => {
...
const ko_nav_splitview1 = /** @type {(inputs: Nav_Splitview1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`분할 보기`)
};
...
const nav_splitview1 = /** @type {((inputs?: Nav_Splitview1Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Nav_Splitview1Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "es") return es_nav_splitview1(inputs)
	if (locale === "hi") return hi_nav_splitview1(inputs)
	if (locale === "pt") return pt_nav_splitview1(inputs)
	...
	if (locale === "ar") return ar_nav_splitview1(inputs)
	if (locale === "wuu") return wuu_nav_splitview1(inputs)
	if (locale === "mr") return mr_nav_splitview1(inputs)
	if (locale === "nb") return nb_nav_splitview1(inputs)
	if (locale === "fi") return fi_nav_splitview1(inputs)
	if (locale === "da") return da_nav_splitview1(inputs)
	if (locale === "et") return et_nav_splitview1(inputs)
	if (locale === "lv") return lv_nav_splitview1(inputs)
	if (locale === "lt") return lt_nav_splitview1(inputs)
	if (locale === "pl") return pl_nav_splitview1(inputs)
	if (locale === "de") return de_nav_splitview1(inputs)
	if (locale === "nl") return nl_nav_splitview1(inputs)
	if (locale === "fr") return fr_nav_splitview1(inputs)
	if (locale === "it") return it_nav_splitview1(inputs)
	if (locale === "hu") return hu_nav_splitview1(inputs)
	if (locale === "cs") return cs_nav_splitview1(inputs)
	if (locale === "ro") return ro_nav_splitview1(inputs)
	if (locale === "el") return el_nav_splitview1(inputs)
	if (locale === "bg") return bg_nav_splitview1(inputs)
	if (locale === "hr") return hr_nav_splitview1(inputs)
