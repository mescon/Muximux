...
/** @typedef {{}} Command_Sectionsettings1Inputs */

const en_command_sectionsettings1 = /** @type {(inputs: Command_Sectionsettings1Inputs) => LocalizedString} */ () => {
...
const ko_command_sectionsettings1 = /** @type {(inputs: Command_Sectionsettings1Inputs) => LocalizedString} */ () => {
...
const command_sectionsettings1 = /** @type {((inputs?: Command_Sectionsettings1Inputs, options?: { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Command_Sectionsettings1Inputs, { locale?: "en" | "sv" | "uk" | "zh" | "es" | "hi" | "pt" | "bn" | "ru" | "ja" | "vi" | "yue" | "tr" | "ar" | "wuu" | "mr" | "nb" | "fi" | "da" | "et" | "lv" | "lt" | "pl" | "de" | "nl" | "fr" | "it" | "hu" | "cs" | "ro" | "el" | "bg" | "hr" | "sr" | "sk" | "sl" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_command_sectionsettings1(inputs)
	if (locale === "zh") return zh_command_sectionsettings1(inputs)
	if (locale === "es") return es_command_sectionsettings1(inputs)
	if (locale === "hi") return hi_command_sectionsettings1(inputs)
	if (locale === "pt") return pt_command_sectionsettings1(inputs)
	...
	if (locale === "ar") return ar_command_sectionsettings1(inputs)
	if (locale === "wuu") return wuu_command_sectionsettings1(inputs)
	if (locale === "mr") return mr_command_sectionsettings1(inputs)
	if (locale === "nb") return nb_command_sectionsettings1(inputs)
	if (locale === "fi") return fi_command_sectionsettings1(inputs)
	if (locale === "da") return da_command_sectionsettings1(inputs)
	if (locale === "et") return et_command_sectionsettings1(inputs)
	if (locale === "lv") return lv_command_sectionsettings1(inputs)
	if (locale === "lt") return lt_command_sectionsettings1(inputs)
	if (locale === "pl") return pl_command_sectionsettings1(inputs)
	if (locale === "de") return de_command_sectionsettings1(inputs)
	if (locale === "nl") return nl_command_sectionsettings1(inputs)
	if (locale === "fr") return fr_command_sectionsettings1(inputs)
	if (locale === "it") return it_command_sectionsettings1(inputs)
	if (locale === "hu") return hu_command_sectionsettings1(inputs)
	if (locale === "cs") return cs_command_sectionsettings1(inputs)
	if (locale === "ro") return ro_command_sectionsettings1(inputs)
	if (locale === "el") return el_command_sectionsettings1(inputs)
	if (locale === "bg") return bg_command_sectionsettings1(inputs)
	if (locale === "hr") return hr_command_sectionsettings1(inputs)
	if (locale === "sr") return sr_command_sectionsettings1(inputs)
	if (locale === "sk") return sk_command_sectionsettings1(inputs)
	if (locale === "sl") return sl_command_sectionsettings1(inputs)
	if (locale === "ko") return ko_command_sectionsettings1(inputs)
	return en_command_sectionsettings1(inputs)
});
export { command_sectionsettings1 as "command_sectionSettings" }