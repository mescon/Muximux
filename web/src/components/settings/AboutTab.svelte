    ...
    <div>
      ...
      <div class="grid grid-cols-3 gap-3 mb-3">
        <div class="rounded-lg bg-bg-surface border border-border p-3 text-center">
          ...
          <div class="text-xs text-text-disabled mb-0.5">{m.about_environment()}</div>
        ...
        <div class="rounded-lg bg-bg-surface border border-border p-3 text-center">
          ...
          <div class="text-xs text-text-disabled mb-0.5">{m.about_platform()}</div>
        ...
        <div class="rounded-lg bg-bg-surface border border-border p-3 text-center">
          ...
          <div class="text-xs text-text-disabled mb-0.5">{m.about_uptime()}</div>
      ...
      <div class="rounded-lg bg-bg-surface border border-border divide-y divide-gray-700/50">
        ...
        <div class="flex items-center justify-between px-4 py-2.5">
          <span class="text-xs text-text-disabled">{m.about_goVersion()}</span>
          <span class="text-xs text-text-secondary font-mono">{systemInfo.go_version}</span>
        </div>
        <div class="flex items-center justify-between px-4 py-2.5">
          <span class="text-xs text-text-disabled">{m.about_buildDate()}</span>
          <span class="text-xs text-text-secondary font-mono">{systemInfo.build_date}</span>
        </div>
        <div class="flex items-center justify-between px-4 py-2.5">
          <span class="text-xs text-text-disabled">{m.about_commit()}</span>
